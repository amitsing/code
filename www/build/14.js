...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return UrllistPage; });
...
var UrllistPage = /** @class */ (function () {
    function UrllistPage(navCtrl, navParams, alertCtrl, platform, toastCtrl, storage, apiServices) {
        var _this = this;
    ...
    UrllistPage.prototype.formlist = function () {
        var _this = this;
        this.storage.get('employeeId').then(function (data) {
            _this.employeeId = data;
            console.log(' employeeId== ', _this.employeeId);
        ...
        this.storage.get('deviceId').then(function (data) {
            ...
            _this.apiServices.urllist(apiKey, _this.login_token)
                ...
                if (res.success == 1) {
                    if (res.hasOwnProperty('other_instructions')) {
                        _this.otherInstruction = res['other_instructions'];
                    }
    ...
    UrllistPage.prototype.apiMessage = function (message) {
    ...
    //   }
    // }
    UrllistPage.prototype.subcategoryiframe = function (index, formdata) {
        // if (
    ...
    UrllistPage.prototype.ionViewWillEnter = function () {
        this.formlist();
    };
    UrllistPage.prototype.showRejectionResigion = function (msg) {
        console.log('msg', msg);
        this.alertfunction(msg);
    };
    UrllistPage.prototype.alertfunction = function (msg) {
    ...
    UrllistPage.prototype.goToForm = function (data) {
        if (data.country_id == "2" || data.country_id == "1") {
            ...
            if (data.form_link == 'chille_background') {
                this.navCtrl.push('BackgroundVerificationPage', { 'data': data });
            }
            else if (data.form_link == 'chille_conesnt') {
                this.navCtrl.push('EmployeeConsentFormPage', { 'data': data });
            }
            else if (data.form_link == 'chille_onboarding') {
                this.navCtrl.push('OnboardingFormPage', { 'data': data });
            }
            else if (data.form_link == 'chile_declaration_form') {
                this.navCtrl.push('DeclarationPage', { 'data': data });
            }
            else if (data.form_link == 'chille_compliance_undertaking') {
                this.navCtrl.push('CompanyPolicyPage', { 'data': data });
            }
            else if (data.form_link == 'all_global_policy') {
                this.navCtrl.push('GlobalpolicylistPage', { "data": data });
            }
            else if (data.form_link == 'chile_declaration_policy') {
                this.navCtrl.push('PolicyDeclarationPage', { 'data': data });
            }
        }
        else if (data.country_id == '5' || data.country_id == '1') {
            if (data.form_link == 'romania_declaration_form') {
                this.navCtrl.push('RomaniaCommonPage', { 'data': data });
            }
            else if (data.form_link == 'romania_labor_contract') {
                this.navCtrl.push('RomaniaCommonPage', { 'data': data });
            }
            else if (data.form_link == 'romania_nda') {
                this.navCtrl.push('RomaniaCommonPage', { 'data': data });
            }
            else if (data.form_link == 'romania_consent') {
                this.navCtrl.push('RomaniaCommonPage', { 'data': data });
            }
            else if (data.form_link == 'romania_consimtamant') {
                this.navCtrl.push('RomaniaCommonPage', { 'data': data });
            }
            else if (data.form_link == 'romania_mandat') {
                this.navCtrl.push('RomaniaCommonPage', { 'data': data });
            }
            else if (data.form_link == 'romania_deduction') {
                this.navCtrl.push('RomaniaCommonPage', { 'data': data });
            }
            else if (data.form_link == 'romania_gdpr_compliance') {
                this.navCtrl.push('RomaniaCommonPage', { 'data': data });
            }
            else if (data.form_link == 'romania_first_day') {
                this.navCtrl.push('RomaniaCommonPage', { 'data': data });
            }
            else if (data.form_link == 'romania_evaluation') {
                this.navCtrl.push('RomaniaCommonPage', { 'data': data });
            }
            else if (data.form_link == 'romania_nda_policy') {
                this.navCtrl.push('RomaniaCommonPage', { 'data': data });
            }
            else if (data.form_link == 'romania_declaration_policy') {
                this.navCtrl.push('PolicyDeclarationPage', { 'data': data });
            }
            else if (data.form_link == 'romania_gdpr_policy') {
                this.navCtrl.push('RomaniaCommonPage', { 'data': data });
            }
            else if (data.form_link == 'romania_mandat_policy') {
                this.navCtrl.push('RomaniaCommonPage', { 'data': data });
            }
            else if (data.form_link == 'romania_evalutation_policy') {
                this.navCtrl.push('RomaniaCommonPage', { 'data': data });
            }
            else if (data.form_link == 'romania_global_policy') {
                this.navCtrl.push('GlobalpolicylistPage', { 'data': data });
            }
        }
        else if (data.country_id == '6' || data.country_id == '1') {
            if (data.form_link == 'china_consent_english') {
            ...
            else if (data.form_link == 'china_acknowledge_receipt') {
                this.navCtrl.push('CompanyPolicyPage', { 'data': data });
            }
            else if (data.form_link == 'china_personal_account_policy') {
                this.navCtrl.push('CompanyPolicyPage', { 'data': data });
            }
            else if (data.form_link == 'china_nda_policy') {
                this.navCtrl.push('CompanyPolicyPage', { 'data': data });
            }
            else if (data.form_link == 'china_acknowledge_receipt') {
                this.navCtrl.push('CompanyPolicyPage', { 'data': data });
            }
            else if (data.form_link == 'china_declaration_policy') {
                this.navCtrl.push('PolicyDeclarationPage', { 'data': data });
            }
            else if (data.form_link == 'china_declaration_form') {
                this.navCtrl.push('PolicyDeclarationPage', { 'data': data });
            }
            else if (data.form_link == 'china_nationality_declaration') {
                this.navCtrl.push('ChinaDeclarationFormPage', { 'data': data });
            }
            else if (data.form_link == 'china_gdpr_policy') {
                this.navCtrl.push('CompanyPolicyPage', { 'data': data });
            }
            else if (data.form_link == 'china_gdprcompliance_policy') {
                this.navCtrl.push('CompanyPolicyPage', { 'data': data });
            }
        }
        else if (data.country_id == '7' || data.country_id == '1' || data.country_id == "8") {
            if (data.form_link == 'usa_self_identification_form') {
                this.navCtrl.push('EvalueserveSelfIdentificationPage', { "data": data });
            }
            else if (data.form_link == 'usa_new_joiner_form') {
                this.navCtrl.push('UsnewjoineeformPage', { 'data': data });
            }
            else if (data.form_link == 'usa_background_form') {
                this.navCtrl.push('BackgroundVerificationUSAPage', { 'data': data });
            }
            else if (data.form_link == 'usa_corporate_form') {
                this.navCtrl.push('UsattendancesheetPage', { 'data': data });
            }
            else if (data.form_link == 'usa_gdprcompliance_form') {
            ...
            else if (data.form_link == 'usa_declaration_form') {
                this.navCtrl.push('PolicyDeclarationPage', { 'data': data });
            }
            else if (data.form_link == 'usa_propretary_form') {
                ...
                data.form_link == 'usa_2019_benefits_policy' || data.form_link == 'usa_2019_benefits_policy') {
                this.navCtrl.push('CompanyPolicyPage', { 'data': data });
            }
            else if (data.form_link == 'all_global_policy') {
                this.navCtrl.push('GlobalpolicylistPage', { 'data': data });
            }
            else if (data.form_link == 'usa_declaration_policy') {
                this.navCtrl.push('PolicyDeclarationPage', { 'data': data });
            }
        }
    ...
    UrllistPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-urllist',template:/*ion-inline-start:"/home/benepik/Desktop/reach_git/new user app/test/Reach_Android_13_dec/Reach_Android/src/pages/urllist/urllist.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>{{title}}</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n  <ion-card  *ngIf="apiData">\n    <div class="firstpositionRelative">\n      <div class="progress-wrapper">\n        <!-- <circle-progress [percent]="50" [radius]="50" [outerStrokeWidth]="6" [showTitle]=true [showSubtitle]=false\n         [showUnits]=false [subtitle]=\'Percent\'\n          [innerStrokeWidth]="3" [outerStrokeColor]="\'#542e56\'" [innerStrokeColor]="\'#7b4b7d\'" [animation]="true" \n          [animationDuration]="300"></circle-progress> -->\n          <circle-progress class="formCircle" [percent]="apiData?.over_all_progress" [radius]="50" [outerStrokeWidth]="6"\n                    [showTitle]=true [title]="apiData?.over_all_progress" [showSubtitle]=false [subtitle]=\'Percent\' \n                     [innerStrokeWidth]="3"\n                    [outerStrokeColor]="\'#542e56\'" [innerStrokeColor]="\'#7b4b7d\'" [animation]="true"\n                    [animationDuration]="300"></circle-progress>\n      </div>\n      <p>{{apiData?.title}}</p>\n      <!-- <div class="percentageValue">\n          {{progressGraph?.remaining_days}} \n        </div> -->\n    </div>\n  </ion-card>\n  <ion-card *ngIf="otherInstruction && otherInstruction.length > 0">\n      <div class="otherInstruction">\n          <show-html [htmlData]="otherInstruction" ></show-html>\n      </div>\n    </ion-card>\n  <ion-card padding margin-bottom *ngIf="apiData" class="relativeDiv overFlowVisible">\n    <ion-row>\n      <ion-col col-3></ion-col>\n      <ion-col col-5></ion-col>\n      <ion-col col-4>\n        <ion-row>\n          <ion-col col-6>\n            <!-- <p class="fontsize">Progress</p> -->\n          </ion-col>\n          <ion-col col-6>\n            <p class="fontsize">\n              <!-- Admin Approvel -->\n              Status\n            </p>\n          </ion-col>\n        </ion-row>\n      </ion-col>\n    </ion-row>\n    <div class="learningList">\n      <div>\n        <div *ngFor="let data of allData ; let i = index">\n          <ion-row class="relativeDiv" margin-bottom style="background-image:url(\'assets/imgs/bg/listbg.png\');background-size:cover;"\n            (click)="subcategoryiframe(i,allData)">\n            <ion-col col-2 no-padding class="paddbottom0">\n              <!-- <img src="assets/imgs/quizicon.png" class="absoluteDiv" /> -->\n              <img srcset="{{data.icon}}" src="../../assets/watermark/watermark.png" class="absoluteDiv" />\n            </ion-col>\n            <ion-col col-6 class="centerDataInDiv paddbottom0">\n              <p style="font-size: 11px;"  class="mt-10 courseTitle">{{data.form_name}}</p>\n            </ion-col>\n            <!-- <ion-col col-1 class="centerDataInDiv paddbottom0">\n              <ion-icon *ngIf="data?.progress!=100" style="font-size: 20px;" name="ios-lock-outline"></ion-icon>\n               <ion-icon *ngIf="data?.progress==100" style="font-size: 20px;" name="ios-unlock-outline"></ion-icon>\n            </ion-col> -->\n            <ion-col col-4 class="centerData paddbottom0">\n              <ion-row>\n                <ion-col col-6 class="padding0 paddbottom0">\n                  <!-- <div class="positionRelative"> -->\n\n                    \n                    <!-- <div style="font-size: 20px;" class="progress-wrapper">\n                      <circle-progress [percent]="data?.progress" [unitsFontSize]="8" [radius]="15" [outerStrokeWidth]="2" [showTitle]=true [showSubtitle]=false\n                        [showUnits]=false [innerStrokeWidth]="2" [outerStrokeColor]="\'#542e56\'" [innerStrokeColor]="\'#7b4b7d\'"\n                        [animation]="true" [animationDuration]="300"></circle-progress>\n                    </div>-->\n\n\n\n                    <!-- <p *ngIf="data?.progress==0" style="    text-align: -webkit-center;" class="martop">\n                     \n                      <img class="inprocess" src="../../assets/imgs/inprocess.png"/>\n                    </p>  \n                    <p *ngIf="data?.progress>0 && data?.progress<=99" class="martop">\n                      <ion-icon name="time" class="pendingIcon" ></ion-icon>\n                    </p>  \n                    <p *ngIf="data?.progress==100">\n                      <ion-icon  name="checkmark-circle-outline" class="approvedIcon"></ion-icon>\n                  </p>\n                  </div> -->\n\n               \n\n\n                  <!-- <p><ion-icon name="time" class="pendingIcon"></ion-icon></p>   -->\n                </ion-col>\n                <ion-col col-6 class="marginauto">\n                  <!-- <p *ngIf="data?.form_status==\'pending\'" class="martop">\n                    <ion-icon name="time" class="pendingIcon" ></ion-icon>\n                  </p>\n                  <p *ngIf="data?.form_status==\'approved\'">\n                      <ion-icon  name="checkmark-circle-outline" class="approvedIcon"></ion-icon>\n                  </p>        \n                  <p  *ngIf="data?.form_status==\'rejected\'">\n                      <ion-icon name="ios-alert-outline" class="rejectedIcon fw" (tap)="showRejectionResigion(data.remarks)" ></ion-icon>         \n                  </p>  -->  \n                  \n                  \n\n                  <!-- <p *ngIf="data?.form_status==\'disable\'" class="martop">\n                      <ion-icon style="font-size: 25px;color:#4c2648;;" name="ios-lock-outline"></ion-icon>\n                  </p> -->\n                   <div class="lockIcon">\n                      <img srcset="{{data.status_icon}}" src="../../assets/watermark/watermark.png" />\n\n                   </div>\n\n                </ion-col>\n              </ion-row>\n\n            </ion-col>\n          </ion-row>\n\n        </div>\n      </div>\n\n    </div>\n    <br>\n    <br>\n    <!-- <div class="btndiv" (click)="gotourllist(data.group_id)">\n      <br>\n      <button ion-button class="btn" round>submit</button>\n    </div> -->\n  </ion-card>\n  <br>\n  <br>\n\n<div *ngIf="!apiData" >\n  <img style="width:100%;"  src="../../assets/imgs/skelton/urllist.png" class="textSkelton" />\n</div>\n\n\n</ion-content>'/*ion-inline-end:"/home/benepik/Desktop/reach_git/new user app/test/Reach_Android_13_dec/Reach_Android/src/pages/urllist/urllist.html"*/,
        }),
...
//# sourceMappingURL=urllist.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "UrllistPageModule", function() { return UrllistPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__urllist__ = __webpack_require__(1186);
...
var UrllistPageModule = /** @class */ (function () {
    function UrllistPageModule() {
    }
    UrllistPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__urllist__["a" /* UrllistPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["p" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__urllist__["a" /* UrllistPage */]), __WEBPACK_IMPORTED_MODULE_3_ng_circle_progress__["a" /* NgCircleProgressModule */], __WEBPACK_IMPORTED_MODULE_4__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], UrllistPageModule);
    return UrllistPageModule;
}());

//# sourceMappingURL=urllist.module.js.map
