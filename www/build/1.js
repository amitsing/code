...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return BackgroundVerificationUSAPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_api_service_api_service__ = __webpack_require__(162);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_storage__ = __webpack_require__(161);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__response__ = __webpack_require__(1143);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__request__ = __webpack_require__(1144);
 ...
 */
var BackgroundVerificationUSAPage = /** @class */ (function () {
    function BackgroundVerificationUSAPage(navCtrl, navParams, _apiService, storage, _el, toastCtrl, loadingCtrl) {
        var _this = this;
    ...
    BackgroundVerificationUSAPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad BackgroundVerificationPage');
    };
    BackgroundVerificationUSAPage.prototype.getData = function () {
        var _this = this;
        var url = "";
        ...
        this._apiService.us_canada(url, apikey, this.login_token).subscribe(function (res) {
            _this.loading.dismiss();
            if (res.success == '1') {
                console.log(res.data);
                _this.formData = new __WEBPACK_IMPORTED_MODULE_4__response__["a" /* BackgroundVerification */]();
                console.log(_this.formData);
                _this.formData.initializeModal(res.data);
                _this.fill_status = res.fill_status;
                _this.msg = res.message;
                setTimeout(function () {
                    var child = _this.form.nativeElement;
                    var allChild = child.querySelectorAll('.inputDiv');
                    // const dateTime = child.querySelectorAll('ion-datetime');
                    console.log(allChild);
                    if (allChild.length > 0) {
                        _this.addListeners(allChild);
                    }
                }, 1000);
            }
            else {
    ...
    BackgroundVerificationUSAPage.prototype.addListeners = function (childs) {
        var child = Array.from(childs);
    ...
    BackgroundVerificationUSAPage.prototype.submit = function () {
        var _this = this;
        this.isSubmited = true;
        setTimeout(function () {
            var parent = _this.form.nativeElement;
            var child = parent.querySelector('.error');
            if (!child) {
                console.log(_this.formData);
                var data = new __WEBPACK_IMPORTED_MODULE_5__request__["a" /* SendData */](_this.formData);
                ...
                if (subChild_1) {
                    subChild_1.scrollIntoView({ behavior: 'smooth', block: 'center', inline: "nearest" });
                    setTimeout(function () {
                        subChild_1.focus();
                    }, 800);
                }
    ...
    BackgroundVerificationUSAPage.prototype.save = function () {
        var data = new __WEBPACK_IMPORTED_MODULE_5__request__["a" /* SendData */](this.formData);
        // console.log(JSON.stringify(data));
        console.log(data);
        this.finalSubmit(data, 'save');
    };
    BackgroundVerificationUSAPage.prototype.finalSubmit = function (data, formStatus) {
        var _this = this;
        var url = "";
        if (this.formD.country_id == 8) {
    ...
    //Common Loader:
    BackgroundVerificationUSAPage.prototype.commonLoader = function () {
    ...
    BackgroundVerificationUSAPage.prototype.apiMessage = function (message) {
    ...
    return BackgroundVerificationUSAPage;
}());

//# sourceMappingURL=background-verification-usa.js.map
...
var BackgroundVerification = /** @class */ (function () {
    function BackgroundVerification() {
        ...
        this.joinee_info = new JoineeInfo();
        this.refrence.push(new Refrence());
        this.permanent_add = new Address();
        this.present_add = new Address();
        this.previous_add.push(new Address());
    }
    ...
    BackgroundVerification.prototype.addAddress = function () {
        var tempAdd = new Address();
        this.previous_add.push(tempAdd);
        console.log('worked');
    };
    BackgroundVerification.prototype.removeAddress = function (data) {
        this.previous_add = this.previous_add.filter(function (element) {
            return data != element;
        });
    };
    BackgroundVerification.prototype.initializeModal = function (data) {
        ...
        this.present_add.initializeAddress(data.present_add);
        this.permanent_add.initializeAddress(data.permanent_add);
        ...
        this.joinee_info.initializeJoineeInfo(data.joinee_info);
        data.refrence.forEach(function (element) {
            var tempRef = new Refrence();
            tempRef.initializeReference(element);
            _this.refrence.push(tempRef);
        });
        data.previous_add.forEach(function (element) {
            var tempAdd = new Address();
            tempAdd.initializeAddress(element);
            _this.previous_add.push(tempAdd);
        });
    };
...
var EducationDetails = /** @class */ (function () {
    ...
    EducationDetails.prototype.initializeEduDetails = function (data) {
        ...
        this.contact_number.InitializeMetaData(data.education_contact_number);
...
var Experience = /** @class */ (function () {
    function Experience() {
        ...
        this.part_time = new metaData();
        this.contact_auth = new metaData();
    ...
    Experience.prototype.initializeExperience = function (data) {
        ...
        this.country_id.InitializeMetaData(data.exp_country_id);
        this.city.InitializeMetaData(data.exp_city);
        this.state.InitializeMetaData(data.exp_state);
        this.zip_code.InitializeMetaData(data.exp_zipcode);
        ...
        this.part_time.InitializeMetaData(data.part_time);
        this.contact_auth.InitializeMetaData(data.contact_auth);
...
var Address = /** @class */ (function () {
    function Address() {
        ...
        this.address_type_2 = null;
        this.available_person_contact_number = new metaData();
        this.city = new metaData();
        this.complete_address = new metaData();
        this.country = new metaData();
        this.country_area_code = new metaData();
        this.end_date = new metaData();
        this.start_date = new metaData();
        this.state = new metaData();
        this.zipcode = new metaData();
    }
    Address.prototype.initializeAddress = function (data) {
        this.auto_id = data.auto_id;
        this.address_type = data.address_type;
        this.address_type_2 = data.address_type_2;
        this.available_person_contact_number.InitializeMetaData(data.available_person_contact_number);
        this.city.InitializeMetaData(data.city);
        this.complete_address.InitializeMetaData(data.complete_address);
        this.country.InitializeMetaData(data.country);
        this.country_area_code.InitializeMetaData(data.country_area_code);
        this.end_date.InitializeMetaData(data.end_date);
        this.start_date.InitializeMetaData(data.start_date);
...
var SendData = /** @class */ (function () {
    function SendData(data) {
        ...
        data.previous_add.forEach(function (element) {
            var tempAdd = new Address(element);
            _this.previous_add.push(tempAdd);
        });
        data.experience.forEach(function (element) {
            var tempExp = new Experience(element);
            _this.experience.push(tempExp);
        });
        data.refrence.forEach(function (element) {
            var tempRef = new Refrence(element);
            _this.refrence.push(tempRef);
        });
...
var Education = /** @class */ (function () {
    ...
    Education.prototype.getMandatoryStatus = function (data) {
        if (data)
            return "1";
        else
            return "0";
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BackgroundVerificationUSAPageModule", function() { return BackgroundVerificationUSAPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__background_verification_usa__ = __webpack_require__(1142);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__directives_directives_module__ = __webpack_require__(887);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_components_module__ = __webpack_require__(873);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var BackgroundVerificationUSAPageModule = /** @class */ (function () {
    function BackgroundVerificationUSAPageModule() {
    }
    BackgroundVerificationUSAPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__background_verification_usa__["a" /* BackgroundVerificationUSAPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["p" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__background_verification_usa__["a" /* BackgroundVerificationUSAPage */]),
                __WEBPACK_IMPORTED_MODULE_3__directives_directives_module__["a" /* DirectivesModule */],
                __WEBPACK_IMPORTED_MODULE_4__components_components_module__["a" /* ComponentsModule */]
            ],
        })
    ], BackgroundVerificationUSAPageModule);
    return BackgroundVerificationUSAPageModule;
}());

//# sourceMappingURL=background-verification-usa.module.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__autofocus_autofocus__ = __webpack_require__(888);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AutofocusDirective = /** @class */ (function () {
    ...
    AutofocusDirective.prototype.ngAfterViewInit = function () {
        ...
        //Add 'implements AfterViewInit' to the class.
        setTimeout(function () {
            _this.elementRef.nativeElement.style.background = '#ff0000';
