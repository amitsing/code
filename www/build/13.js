...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return OnboardingFormPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_api_service_api_service__ = __webpack_require__(162);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__responseFormData__ = __webpack_require__(1093);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_storage__ = __webpack_require__(161);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__requestFormData__ = __webpack_require__(1094);
 ...
 */
var OnboardingFormPage = /** @class */ (function () {
    function OnboardingFormPage(navCtrl, navParams, _apiService, storage, _el, toastCtrl, loadingCtrl) {
        var _this = this;
    ...
    OnboardingFormPage.prototype.ionViewDidLoad = function () {
        console.log("ionViewDidLoad OnboardingFormPage");
    };
    OnboardingFormPage.prototype.getData = function () {
        var _this = this;
        this.commonLoader();
        var apikey = {
        ...
        this._apiService
            ...
            if (res.success == '1') {
                _this.formData = new __WEBPACK_IMPORTED_MODULE_3__responseFormData__["a" /* OnBoardingForm */]();
                console.log(_this.formData);
                _this.fill_status = res.fill_status;
                _this.msg = res.message;
                _this.formData.InitializeOnBoarding(res.data);
                setTimeout(function () {
    ...
    OnboardingFormPage.prototype.getDropDowns = function () {
        var _this = this;
        var apikey = {
            client_id: this._apiService.clientId,
            employee_id: this.employeeId,
        ...
        this._apiService.getDropDown(apikey, this.login_token).subscribe(function (res) {
            console.log(res);
            _this.eduDropDown = res.data.education;
            _this.universityDropDown = res.data.university;
            _this.locationDropDowns = res.data.nature_of_location;
        });
    };
    OnboardingFormPage.prototype.addListeners = function (childs) {
    ...
    OnboardingFormPage.prototype.save = function () {
        console.log(this.formData);
        var data = new __WEBPACK_IMPORTED_MODULE_5__requestFormData__["a" /* OnBoardingFormDetails */](this.formData);
        console.log(JSON.stringify(data));
        this.finalSubmit(data, "save");
    };
    OnboardingFormPage.prototype.submit = function () {
        var _this = this;
        ...
        setTimeout(function () {
            ...
            if (!child) {
                console.log(_this.formData);
                var data = new __WEBPACK_IMPORTED_MODULE_5__requestFormData__["a" /* OnBoardingFormDetails */](_this.formData);
                console.log(JSON.stringify(data));
                _this.finalSubmit(data, "submit");
            }
            else {
                var subChild_1 = child.querySelector("input");
    ...
    OnboardingFormPage.prototype.finalSubmit = function (data, formStatus) {
        var _this = this;
        this.commonLoader();
        var apikey = {
            client_id: this._apiService.clientId,
    ...
    //Common Loader:
    OnboardingFormPage.prototype.commonLoader = function () {
    ...
    OnboardingFormPage.prototype.apiMessage = function (message) {
    ...
    ], OnboardingFormPage.prototype, "form", void 0);
    OnboardingFormPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: "page-onboarding-form",template:/*ion-inline-start:"/home/benepik/Desktop/reach_git/new user app/test/Reach_Android_13_dec/Reach_Android/src/pages/onboarding_forms/Chile/onboarding-form/onboarding-form.html"*/'<!--\n  Generated template for the OnboardingFormPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n  <ion-navbar>\n    <ion-title>{{page_title}}</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding class="bg">\n        <div [ngClass]="{\'newOverlay\':formD.form_status != \'enable\'}"> \n    <div class="container">\n        <div class="row" *ngIf="formData" #form>\n            <div class="col-md-12 col-xs-12 col-sm-12" id="formDiv">\n                <div class="formDiv">\n                    <div>\n                        <h4> Personal Information </h4>\n                     </div>\n                     <customInput\n                        label="Employee Name"\n                        [data]="formData.userData.userName"\n                        type="text"\n                        [otherStatus]="isSubmited"\n                     ></customInput>\n\n                     <customInput\n                        label="Gender"\n                        [data]="formData.userData.gender"\n                        type="radio"\n                        [options] = "genderOptions"\n                        [otherStatus]="isSubmited"\n                     ></customInput>\n\n                     <customInput\n                        label="Phone Number"\n                        [data]="formData.userData.contact"\n                        type="number"\n                        [otherStatus]="isSubmited"\n                     ></customInput>\n\n                     <customInput\n                        label="Father Name"\n                        [data]="formData.userData.father_name"\n                        type="text"\n                        [otherStatus]="isSubmited"\n                     ></customInput>\n\n                     <customInput\n                        label="RUT Number"\n                        [data]="formData.rutData.rut_number"\n                        type="text"\n                        [otherStatus]="isSubmited"\n                     ></customInput>\n\n                     <customInput\n                        label="Passport Number"\n                        [data]="formData.passport.passport"\n                        type="text"\n                        [otherStatus]="isSubmited"\n                     ></customInput>\n\n                     <customInput\n                        label="Date of Birth ( dd/mm/yyyy)"\n                        [data]="formData.userData.date_of_birth"\n                        type="date"\n                        dateFormat = "MM/DD/YYYY"\n                        [otherStatus]="isSubmited"\n                     ></customInput>\n\n                     <customInput\n                        label="Place of Birth"\n                        [data]="formData.userData.place_of_birth"\n                        type="text"\n                        [otherStatus]="isSubmited"\n                     ></customInput>\n\n                     <customInput\n                        label="Nationality"\n                        [data]="formData.userData.nationality_name"\n                        type="text"\n                        [otherStatus]="isSubmited"\n                     ></customInput>\n\n                     <customInput\n                        label="Marital Status"\n                        [data]="formData.userData.marital_status"\n                        type="text"\n                        [otherStatus]="isSubmited"\n                     ></customInput>\n\n                     <customInput\n                        label="Emergency Contact Name"\n                        [data]="formData.emgData.emg_contact_name"\n                        type="text"\n                        [otherStatus]="isSubmited"\n                     ></customInput>\n\n                     <customInput\n                        label="Emergency Contact Telephone"\n                        [data]="formData.emgData.emg_contact_number"\n                        type="number"\n                        [otherStatus]="isSubmited"\n                    ></customInput>\n\n                    <customInput\n                        label="University"\n                        [data]="formData.eduData.university_name"\n                        type="text"\n                        [otherStatus]="isSubmited"\n                     ></customInput>\n\n                     <customInput\n                        label="University Degree"\n                        [data]="formData.eduData.education_specialization_id"\n                        type="select"\n                        [options] = "universityDropDown"\n                        [otherStatus]="isSubmited"\n                     ></customInput>\n\n                     <customInput\n                        label="Education Level"\n                        [data]="formData.eduData.level_of_education"\n                        type="select"\n                        [options]="eduDropDown"\n                        [otherStatus]="isSubmited"\n                     ></customInput>\n\n                     <customInput\n                        label="E-mail Id "\n                        [data]="formData.userData.email_id"\n                        type="text"\n                        [otherStatus]="isSubmited"\n                    ></customInput>\n\n              \n                </div>\n\n             <div class="formDiv">\n                    <div>\n                        <h4> HR Information </h4>\n                     </div>\n\n                     <customInput\n                        label="Designation "\n                        [data]="formData.userData.designation"\n                        type="text"\n                        [otherStatus]="isSubmited"\n                     ></customInput>\n\n                     <customInput\n                        label="Department "\n                        [data]="formData.userData.department"\n                        type="text"\n                        [otherStatus]="isSubmited"\n                    ></customInput>\n\n                    <customInput\n                        label="RM"\n                        [data]="formData.rmDetail.contact_person"\n                        type="text"\n                        [otherStatus]="isSubmited"\n                    ></customInput>\n\n                    <customInput\n                        label="Date of Joining (dd/mm/yyyy)"\n                        [data]="formData.userData.date_of_joining"\n                        type="date"\n                        dateFormat ="MM/DD/YYYY"\n                        [otherStatus]="isSubmited"\n                    ></customInput>\n\n               \n             </div>\n\n             <div class="formDiv">\n                    <div>\n                        <h4> Residential Information </h4>\n                     </div>\n\n                     <customInput\n                        label="Permanent Address"\n                        [data]="formData.address.address"\n                        type="text"\n                        [otherStatus]="isSubmited"\n                    ></customInput> \n\n                    <customInput\n                        label="Zip Code"\n                        [data]="formData.address.zipcode"\n                        type="text"\n                        [otherStatus]="isSubmited"\n                    ></customInput> \n\n                    <customInput\n                        label="City"\n                        [data]="formData.address.city"\n                        type="text"\n                        [otherStatus]="isSubmited"\n                    ></customInput> \n\n                    <customInput\n                        label="State / Reg"\n                        [data]="formData.address.state"\n                        type="text"\n                        [otherStatus]="isSubmited"\n                    ></customInput> \n\n                    <customInput\n                        label="Country"\n                        [data]="formData.address.country"\n                        type="text"\n                        [otherStatus]="isSubmited"\n                    ></customInput> \n\n                    <customInput\n                        label="Residence Since (mm/yy)"\n                        [data]="formData.address.residing_since"\n                        type="date"\n                        dateForrmat = "MM/YYYY"\n                        [otherStatus]="isSubmited"\n                    ></customInput> \n\n                    <customInput\n                        label="Nature of Location"\n                        [data]="formData.address.nature_of_location"\n                        type="select"\n                        [options] = "locationDropDowns"\n                        [otherStatus]="isSubmited"\n                    ></customInput> \n\n                    <customInput\n                        label="Address in Chile"\n                        [data]="formData.address.chile_address"\n                        type="text"\n                        [otherStatus]="isSubmited"\n                    ></customInput> \n\n                   \n             </div>\n             <div class="formDiv">\n                <show-html [htmlData]="msg"></show-html>\n            </div>\n              \n            </div>\n        </div>\n    </div>\n    <ion-row *ngIf="formD && formD.form_status == \'enable\'">\n        <ion-col text-center col-6 *ngIf="fill_status == \'0\'">\n                <div class="btndiv">\n                        <button ion-button class="btn" (click)=" save()">Save</button>\n                </div>\n        </ion-col>\n        <ion-col [attr.col-12]="fill_status == \'1\' ? \'\' : null"\n                 [attr.col-6]="fill_status == \'0\' ? \'\' : null">\n      \n          <div class="btndiv">\n                <button ion-button class="btn" (click)="submit()">{{ fill_status==\'1\' ? \'Update\' : \'Submit\'  }}</button>\n          </div>\n        </ion-col>\n      </ion-row>\n        </div>\n</ion-content>\n'/*ion-inline-end:"/home/benepik/Desktop/reach_git/new user app/test/Reach_Android_13_dec/Reach_Android/src/pages/onboarding_forms/Chile/onboarding-form/onboarding-form.html"*/
        }),
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return OnBoardingForm; });
var OnBoardingForm = /** @class */ (function () {
    ...
    OnBoardingForm.prototype.InitializeOnBoarding = function (data) {
...
var Passport = /** @class */ (function () {
    ...
    Passport.prototype.initializePassport = function (data) {
...
var UserData = /** @class */ (function () {
    ...
    UserData.prototype.initializeUserData = function (data) {
...
var EduData = /** @class */ (function () {
    ...
    EduData.prototype.initializeEduData = function (data) {
...
var EmgData = /** @class */ (function () {
    function EmgData() {
        this.emg_contact_name = new metaData();
        this.emg_contact_number = new metaData();
    }
    EmgData.prototype.initializeEmgData = function (data) {
...
var RmDetail = /** @class */ (function () {
    function RmDetail() {
        this.contact_person = new metaData();
    }
    RmDetail.prototype.initializeRmDetail = function (data) {
        this.contact_person.InitializeMetaData(data.contact_person);
    };
    return RmDetail;
}());
var RutData = /** @class */ (function () {
    function RutData() {
        this.rut_number = new metaData();
    }
    RutData.prototype.initializeRutData = function (data) {
...
//# sourceMappingURL=responseFormData.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return OnBoardingFormDetails; });
var OnBoardingFormDetails = /** @class */ (function () {
    function OnBoardingFormDetails(data) {
...
var RmDetail = /** @class */ (function () {
    function RmDetail(data) {
        this.contact_person = data.contact_person.value;
    }
    return RmDetail;
}());
var RutData = /** @class */ (function () {
    function RutData(data) {
        this.rut_number = data.rut_number.value;
    }
    return RutData;
}());
//# sourceMappingURL=requestFormData.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OnboardingFormPageModule", function() { return OnboardingFormPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__onboarding_form__ = __webpack_require__(1092);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(873);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_ionic_tooltips__ = __webpack_require__(870);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var OnboardingFormPageModule = /** @class */ (function () {
    function OnboardingFormPageModule() {
    }
    OnboardingFormPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [__WEBPACK_IMPORTED_MODULE_2__onboarding_form__["a" /* OnboardingFormPage */]],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["p" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__onboarding_form__["a" /* OnboardingFormPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
                __WEBPACK_IMPORTED_MODULE_4_ionic_tooltips__["a" /* TooltipsModule */].forRoot()
            ]
        })
    ], OnboardingFormPageModule);
    return OnboardingFormPageModule;
}());

//# sourceMappingURL=onboarding-form.module.js.map
