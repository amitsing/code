...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return EmployeeConsentFormPage; });
 ...
 */
var EmployeeConsentFormPage = /** @class */ (function () {
    function EmployeeConsentFormPage(navCtrl, navParams, _apiService, storage, toastCtrl, loadingCtrl) {
        var _this = this;
    ...
    EmployeeConsentFormPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad EmployeeConsentFormPage');
    };
    EmployeeConsentFormPage.prototype.gform = function () {
        var _this = this;
        this.commonLoader();
        var apiKey = {
        ...
        this._apiService.china_consent(apiKey, this.login_token).subscribe(function (res) {
            console.log('tnc res==', res);
            _this.loading.dismiss();
            if (res.success == '1') {
                _this.allData = _this.setUserRespone(res.data);
                console.log(_this.allData);
                _this.partA = res.part_A;
                _this.partB = res.part_B;
                _this.partC = res.part_C;
    ...
    EmployeeConsentFormPage.prototype.setUserRespone = function (main_data) {
    ...
    EmployeeConsentFormPage.prototype.submit = function () {
        var _this = this;
        console.log(this.allData);
        this.isSubmited = true;
        setTimeout(function () {
            var mendatory = document.querySelector('.mendatory');
            setTimeout(function () {
                if (!mendatory) {
                    var error = document.querySelector('.error');
                    setTimeout(function () {
                        if (!error) {
                            var data = _this.requestData(_this.allData);
                            console.log(data);
                            _this.finalSubmit(data);
                        }
                        else {
                            _this.apiMessage('Please fill all the fields to continue');
                            error.scrollIntoView({ behavior: "smooth", block: "center", inline: "nearest" });
                        }
                    }, 100);
                }
                else {
                    _this.apiMessage('Accepting the consent form is mandatory to close joining process.');
                    mendatory.scrollIntoView({ behavior: "smooth", block: "center", inline: "nearest" });
                }
            }, 100);
        }, 250);
    };
    EmployeeConsentFormPage.prototype.finalSubmit = function (data) {
        var _this = this;
        this.commonLoader();
        var apiKey = {
            "client_id": this._apiService.clientId,
        ...
        this._apiService.china_consent_submit(apiKey, this.login_token).subscribe(function (res) {
            _this.loading.dismiss();
            console.log(res);
            if (res.success == '1') {
                _this.apiMessage(res.message);
    ...
    EmployeeConsentFormPage.prototype.requestData = function (allData) {
        var _this = this;
        this.answer_arr = [];
        allData.forEach(function (data) {
            data.forEach(function (element) {
                ...
                _this.answer_arr.push(tempData);
            });
        });
        return this.answer_arr;
    };
    //Common Loader:
    EmployeeConsentFormPage.prototype.commonLoader = function () {
    ...
    EmployeeConsentFormPage.prototype.apiMessage = function (message) {
    ...
    EmployeeConsentFormPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-employee-consent-form',template:/*ion-inline-start:"/home/benepik/Desktop/reach_git/new user app/test/Reach_Android_13_dec/Reach_Android/src/pages/onboarding_forms/Chile/employee-consent-form/employee-consent-form.html"*/'<!--\n  Generated template for the EmployeeConsentFormPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n  <ion-navbar>\n    <ion-title>{{page_title}}</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding class="bg">\n    <div [ngClass]="{\'newOverlay\':formData.form_status != \'enable\'}"> \n    <div class="row" *ngIf="allData">\n        <div class="col-md-12 col-xs-12 col-sm-12" id="formDiv" style="display: block;">\n            <div >\n                <div style="float: right; margin: -9px -7px 0px 0px; display: none" id="editBtn">\n                    <i class="fa fa-edit fa-2x" style="color:cadetblue" aria-hidden="true" title="edit" id="edit" onclick="edit();"></i>\n                </div>\n                <show-html [htmlData]="partA.description" ></show-html>\n            </div>\n            <div  *ngFor="let item of allData; let j = index;">\n                <p class="theme-color" *ngIf="j==0"><show-html [htmlData]="partA.data_A" ></show-html></p>\n                <p class="theme-color" *ngIf="j==1"><show-html [htmlData]="partA.data_B" ></show-html></p>\n                <div style="margin-top: 20px; display: inline-block;" *ngIf="j==2"><show-html [htmlData]="partB.description" ></show-html></div>\n                <div class="card formDiv" *ngFor="let data of item; let i = index" \n                    style="border: 1px solid silver; margin: 5px 0"\n                    [ngClass]="{\'mendatory\': j==0 && isSubmited && (data.userAnswer == \'\' || data.userAnswer == \'0\'), \'error\': data.userAnswer == \'\' && isSubmited }"\n                    >\n                    <div class="card-body" >\n                        <strong class="card-title">Question {{ i + 1 }}</strong>\n                        <p class="card-text" [innerHTML]="data.question"></p>\n                        <ion-list radio-group [(ngModel)]="data.userAnswer">\n                            <ion-row class="radioNewDiv">\n                                <ion-col col-6>\n                                    <ion-item>\n                                        <ion-label>Yes</ion-label>\n                                        <ion-radio value="1"></ion-radio>\n                                    </ion-item>\n                                </ion-col>\n                                <ion-col col-6>\n                                    <ion-item>0\n                                        <ion-label>No</ion-label>\n                                        <ion-radio value="0"></ion-radio>\n                                    </ion-item>\n                                </ion-col>\n                            </ion-row>\n                        </ion-list>\n                    </div>\n                </div>\n                <div style="margin-top: 20px; display: inline-block;" *ngIf="j==2"><show-html [htmlData]="partB.end_description" ></show-html></div>\n            </div>\n            <div style="margin: 10px 0;" class="formDiv">\n                <show-html [htmlData]="partC.description" ></show-html>\n            </div> \n            <div class="btndiv" *ngIf="formData && formData.form_status == \'enable\'">\n                <button ion-button class="btn" (click)="submit()">{{ fill_status==\'1\' ? \'Update\' : \'Submit\' }}</button>\n            </div>\n            <!-- <div text-center class="submitBtn" id="submit"> \n                <button type="submit" id="submitFinal" name="submitFinal" (click)="submit()">Submit</button>    \n            </div>  -->\n        </div>\n    </div>\n        </div>\n</ion-content>\n'/*ion-inline-end:"/home/benepik/Desktop/reach_git/new user app/test/Reach_Android_13_dec/Reach_Android/src/pages/onboarding_forms/Chile/employee-consent-form/employee-consent-form.html"*/,
        }),
    ...
    return EmployeeConsentFormPage;
}());

//# sourceMappingURL=employee-consent-form.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EmployeeConsentFormPageModule", function() { return EmployeeConsentFormPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__employee_consent_form__ = __webpack_require__(1091);
...
var EmployeeConsentFormPageModule = /** @class */ (function () {
    function EmployeeConsentFormPageModule() {
    }
    EmployeeConsentFormPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__employee_consent_form__["a" /* EmployeeConsentFormPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["p" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__employee_consent_form__["a" /* EmployeeConsentFormPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */]
            ],
        })
    ], EmployeeConsentFormPageModule);
    return EmployeeConsentFormPageModule;
}());

//# sourceMappingURL=employee-consent-form.module.js.map
