...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__response__ = __webpack_require__(1133);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__request__ = __webpack_require__(1134);
...
var CreditCardPage = /** @class */ (function () {
    function CreditCardPage(navCtrl, navParams, _apiService, storage, toastCtrl, loadingCtrl, alertCtrl) {
        var _this = this;
    ...
    CreditCardPage.prototype.getData = function () {
        var _this = this;
        this.commonLoader();
        var apikey = {
        ...
        this._apiService
            ...
            if (res.success == '1') {
                ...
                _this.data = new __WEBPACK_IMPORTED_MODULE_4__response__["a" /* Credit */]();
                _this.data.initializeCredit(res.data);
                console.log(res);
            }
            else {
    ...
    CreditCardPage.prototype.getDropDowns = function () {
        var _this = this;
        var apikey = {
            client_id: this._apiService.clientId,
            employee_id: this.employeeId,
        ...
        this._apiService
            ...
            .subscribe(function (res) {
            console.log(res);
            _this.genderOption = res.data.gender;
            _this.titleOption = res.data.title;
        });
    };
    CreditCardPage.prototype.save = function () {
        console.log(this.data);
        var data = new __WEBPACK_IMPORTED_MODULE_5__request__["a" /* CreditReq */](this.data);
        console.log(data);
        this.finalSubmit(data, "save");
    };
    CreditCardPage.prototype.submit = function () {
        var _this = this;
        ...
        setTimeout(function () {
            ...
            if (!child) {
                ...
                var data = new __WEBPACK_IMPORTED_MODULE_5__request__["a" /* CreditReq */](_this.data);
                console.log(data);
    ...
    CreditCardPage.prototype.getCutrrentDate = function () {
        var todayTime = new Date();
        return todayTime.getFullYear() + "-" + (todayTime.getMonth() + 1) + "-" + todayTime.getDate();
    };
    CreditCardPage.prototype.getFutureDate = function () {
        var todayTime = new Date();
        return todayTime.getFullYear() + 100 + "-" + (todayTime.getMonth() + 1) + "-" + todayTime.getDate();
    };
    //Common Loader:
    CreditCardPage.prototype.commonLoader = function () {
    ...
    CreditCardPage.prototype.apiMessage = function (message) {
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return Credit; });
/* unused harmony export CreditDetails */
/* unused harmony export PrevAddress */
/* unused harmony export PresentAddress */
/* unused harmony export UserDetail */
...
var Credit = /** @class */ (function () {
    ...
    Credit.prototype.initializeCredit = function (data) {
...
var CreditDetails = /** @class */ (function () {
    ...
    CreditDetails.prototype.initializeCreditCardDetails = function (data) {
...
var PrevAddress = /** @class */ (function () {
    ...
    PrevAddress.prototype.initializePrevAddress = function (data) {
        this.auto_id = data.auto_id;
...
var PresentAddress = /** @class */ (function () {
    ...
    PresentAddress.prototype.initializePresentAddress = function (data) {
        this.auto_id = data.auto_id;
        this.address.InitializeMetaData(data.address);
        this.postal_code.InitializeMetaData(data.postal_code);
...
var UserDetail = /** @class */ (function () {
    ...
    UserDetail.prototype.initializeUserDetails = function (data) {
...
var metaData = /** @class */ (function () {
    ...
    metaData.prototype.checkWordCount = function (num) {
        if (this.value) {
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CreditReq; });
/* unused harmony export CreditDetails */
/* unused harmony export PrevAddress */
/* unused harmony export PresentAddress */
/* unused harmony export UserDetail */
var CreditReq = /** @class */ (function () {
    function CreditReq(data) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__credit_card__ = __webpack_require__(1132);
...
var CreditCardPageModule = /** @class */ (function () {
    ...
    CreditCardPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["p" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__credit_card__["a" /* CreditCardPage */]),
