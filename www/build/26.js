...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return LifeAtEvalDetailsPage; });
 ...
 */
var LifeAtEvalDetailsPage = /** @class */ (function () {
    function LifeAtEvalDetailsPage(storage, apiServices, iab, imageViewerCtrl, navCtrl, navParams) {
        var _this = this;
    ...
    LifeAtEvalDetailsPage.prototype.ionViewDidLoad = function () {
        var _this = this;
    ...
    LifeAtEvalDetailsPage.prototype.seeNewsdetails = function () {
        var _this = this;
        this.storage.get('deviceId').then(function (data) {
            ...
            var apiKey = {
                ...
                "news_id": _this.previousePageData.auto_id
            };
            console.log('seeNewsdetails api key==', apiKey);
            _this.apiServices.onboardnewsDetails(apiKey, _this.login_token).subscribe(function (result) {
                console.log(' seeNewsdetails data response== ', result);
                _this.allData = result;
                if (_this.allData.success == 1) {
                    _this.details = _this.allData.data;
                }
                else {
                    _this.details = [];
    ...
    LifeAtEvalDetailsPage.prototype.commentDetect = function (ev, myComment) {
    ...
    LifeAtEvalDetailsPage.prototype.handleClick = function (event) {
        if (event.target.tagName == "A") {
            this.iab.create(event.target.href, "_system", this.options);
            return false;
        }
    };
    LifeAtEvalDetailsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-life-at-eval-details',template:/*ion-inline-start:"/home/benepik/Desktop/reach_git/new user app/test/Reach_Android_13_dec/Reach_Android/src/pages/life-at-eval-details/life-at-eval-details.html"*/'<ion-header>\n  <ion-navbar>\n    <!-- <ion-title>{{previousePageData.title}}</ion-title> -->\n\n    <ion-title>Know More</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content >\n    <div *ngIf="!details">\n      <post-details-skelton></post-details-skelton>\n    </div>\n\n  <div *ngIf="details">\n\n \n        <div *ngIf="previousePageData?.media_type==\'1\'">\n                <img class="imgcss" onError="this.src=\'../../assets/watermark/watermark.png\'" #myImage\n                src="{{previousePageData?.media}}" (click)="presentImage(myImage)">\n            </div>\n             <div  *ngIf="previousePageData?.media_type==\'3\'">\n                <iframe  width="100%" style="height:180px;"\n                [src]="previousePageData?.media+\'?autoplay=0\'|safe" autostart="0"\n                allowfullscreen frameborder="0" scrolling="no"></iframe>\n             </div>\n             <div *ngIf="previousePageData?.media_type==\'2\'">\n                 <video [src]="previousePageData?.media|safe" height="180px"  width="100%"  poster="{{previousePageData?.thumbnail_image}}" controls controlsList="nodownload" type="video/*">\n                 </video>\n              </div>\n\n<div padding>\n<ion-row>\n    <ion-col col-12>\n        <div class="post-title">{{previousePageData.title}}</div>\n    </ion-col>\n    <ion-col col-12>\n        <div [innerHTML]="previousePageData.content" (click)="handleClick($event)"></div>\n    </ion-col>\n\n    <!-- <ion-col col-12 class="bottom-line">\n        <button ion-button color="theme" small clear>3 Likes</button>\n        <button ion-button color="theme" small clear>2 Comments</button>\n    </ion-col> -->\n\n\n\n\n</ion-row>\n\n<!-- <ion-row class="themeShadow">\n    <ion-col col-6>\n        <button ion-button color="theme" clear> <ion-icon name="md-thumbs-up"></ion-icon>&nbsp;&nbsp; Like</button>\n    </ion-col>\n\n    <ion-col col-6>\n        <button ion-button color="theme" clear> <ion-icon name="md-chatboxes"></ion-icon>&nbsp;&nbsp; Comment</button>\n    </ion-col>\n</ion-row>\n\n\n<ion-row >\n    <ion-col col-12>\n        <p>2 Comments</p>\n    </ion-col>\n</ion-row> -->\n<!-- this is comment view -->\n<!-- <ion-row *ngFor="let data of [0,1]">\n    <ion-col col-2>\n      <img [src]="previousePageData.userImage" class="commentedUserImage" imageViewer/>\n    </ion-col>\n    <ion-col col-10>\n      <div class="commentHolder">\n        <p class="commentedUserName">Test</p>\n        <p class="commentedUserLocation">Pune</p>\n        <p class="commentedUserDate">02 May, 2019</p>\n        <p class="comment">Very nice article</p>\n      </div>\n      <ion-row>\n          <ion-col col-12 >\n              <button ion-button color="theme" small clear><ion-icon name="md-thumbs-up"></ion-icon>.&nbsp;&nbsp; 3 Likes</button>\n            |  <button ion-button color="theme" small clear><ion-icon name="md-chatboxes"></ion-icon>.&nbsp;&nbsp;2 Comments</button>\n          </ion-col>\n      </ion-row>\n    </ion-col>\n\n</ion-row> -->\n\n\n\n\n</div>\n\n</div>\n</ion-content>\n<!-- <ion-footer>\n    <ion-row>\n        <ion-col col-9 >\n          <ion-input type="text" placeholder="Write a comment..." [(ngModel)]="comment" class="commentField" (ngModelChange)="commentDetect($events, comment)"></ion-input>\n        </ion-col>\n        <ion-col col-1 > \n            <button ion-button small color="theme" clear><ion-icon name="images"></ion-icon></button>\n        </ion-col>\n        <ion-col col-2 >\n            <button [disabled]="showSendBtn==false" small ion-button color="theme" clear><ion-icon name="send"></ion-icon></button>\n          </ion-col>\n    </ion-row>\n  </ion-footer> -->'/*ion-inline-end:"/home/benepik/Desktop/reach_git/new user app/test/Reach_Android_13_dec/Reach_Android/src/pages/life-at-eval-details/life-at-eval-details.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4__ionic_storage__["b" /* Storage */], __WEBPACK_IMPORTED_MODULE_3__providers_api_service_api_service__["a" /* ApiServiceProvider */], __WEBPACK_IMPORTED_MODULE_5__ionic_native_in_app_browser__["a" /* InAppBrowser */],
            __WEBPACK_IMPORTED_MODULE_2_ionic_img_viewer__["a" /* ImageViewerController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["u" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["v" /* NavParams */]])
    ], LifeAtEvalDetailsPage);
    return LifeAtEvalDetailsPage;
}());

//# sourceMappingURL=life-at-eval-details.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LifeAtEvalDetailsPageModule", function() { return LifeAtEvalDetailsPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__life_at_eval_details__ = __webpack_require__(1075);
...
var LifeAtEvalDetailsPageModule = /** @class */ (function () {
    function LifeAtEvalDetailsPageModule() {
    }
    LifeAtEvalDetailsPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__life_at_eval_details__["a" /* LifeAtEvalDetailsPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["p" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__life_at_eval_details__["a" /* LifeAtEvalDetailsPage */]), __WEBPACK_IMPORTED_MODULE_3_ionic_img_viewer__["b" /* IonicImageViewerModule */], __WEBPACK_IMPORTED_MODULE_4__components_components_module__["a" /* ComponentsModule */], __WEBPACK_IMPORTED_MODULE_5__pipes_pipes_module__["a" /* PipesModule */]
            ],
        })
    ], LifeAtEvalDetailsPageModule);
    return LifeAtEvalDetailsPageModule;
}());

//# sourceMappingURL=life-at-eval-details.module.js.map
