...
var CompanyPolicyPage = /** @class */ (function () {
    function CompanyPolicyPage(navCtrl, navParams, _apiService, storage, toastCtrl, loadingCtrl) {
        var _this = this;
    ...
    CompanyPolicyPage.prototype.hideLangPopUp = function (val) {
        if (val == 'show') {
    ...
    CompanyPolicyPage.prototype.getCompanyPolicy = function () {
        var _this = this;
        this.commonLoader();
        var apikey = {
        ...
        this._apiService.getFormPolicy(apikey, this.login_token).subscribe(function (res) {
    ...
    CompanyPolicyPage.prototype.submit = function () {
        var _this = this;
        var apikey = {
            "client_id": this._apiService.clientId,
            "employee_id": this.employeeId,
        ...
        if (this.fill_status == '0') {
            this.commonLoader();
            this._apiService.submitFormPolicy(apikey, this.login_token).subscribe(function (res) {
                _this.loading.dismiss();
                if (res.success == '1') {
                    _this.apiMessage(res.message);
                    _this.navCtrl.pop();
    ...
    //Common Loader:
    CompanyPolicyPage.prototype.commonLoader = function () {
    ...
    CompanyPolicyPage.prototype.apiMessage = function (message) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__company_policy__ = __webpack_require__(1100);
...
var CompanyPolicyPageModule = /** @class */ (function () {
    ...
    CompanyPolicyPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__company_policy__["a" /* CompanyPolicyPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["p" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__company_policy__["a" /* CompanyPolicyPage */]),
...
//# sourceMappingURL=company-policy.module.js.map
