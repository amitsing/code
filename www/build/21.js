...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return DeclarationPage; });
 ...
 */
var DeclarationPage = /** @class */ (function () {
    function DeclarationPage(navCtrl, navParams, _apiService, storage, toastCtrl, loadingCtrl) {
        var _this = this;
    ...
    DeclarationPage.prototype.getData = function () {
        var _this = this;
        this.commonLoader();
        var apikey = {
        ...
        this._apiService
            ...
            if (res.success == '1') {
                _this.declarationData = res.data;
            }
            else {
    ...
    DeclarationPage.prototype.ionViewDidLoad = function () {
        console.log("ionViewDidLoad DeclarationPage");
    };
    DeclarationPage.prototype.submit = function () {
        this.isSubmited = true;
        console.log(this.data);
        if (this.data.name_check == "true") {
            if (this.data.currunt_date.trim() &&
    ...
    DeclarationPage.prototype.finalSubmit = function () {
        var _this = this;
        var apikey = {
            client_id: this._apiService.clientId,
            employee_id: this.employeeId,
        ...
        this._apiService
            ...
            console.log(res);
            if (res.success == '1') {
                _this.navCtrl.push('DeclarationotpPage', { "form_data": _this.formData, "otpdata": res.otp_id });
            }
            else {
                _this.apiMessage(res.message);
            }
    ...
    DeclarationPage.prototype.getFormattedDate = function () {
        var todayTime = new Date();
        return todayTime.getFullYear() + "-" + (todayTime.getMonth() + 1) + "-" + todayTime.getDate();
    };
    //Common Loader:
    DeclarationPage.prototype.commonLoader = function () {
    ...
    DeclarationPage.prototype.apiMessage = function (message) {
    ...
    DeclarationPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: "page-declaration",template:/*ion-inline-start:"/home/benepik/Desktop/reach_git/new user app/test/Reach_Android_13_dec/Reach_Android/src/pages/onboarding_forms/Chile/declaration/declaration.html"*/'\n<ion-header>\n  <ion-navbar>\n    <ion-title>{{page_title}}</ion-title>\n  </ion-navbar>\n</ion-header>\n<!-- *ngIf="declarationData && declarationData.length>0" -->\n<ion-content padding class="bg">\n        <div [ngClass]="{\'newOverlay\':formData.form_status != \'enable\'}"> \n  <ion-row >\n    <ion-col col-12>\n        <div class="formDiv">\n            <div class="cont">\n                <ion-row>\n                    <ion-col col-12 *ngFor="let item of declarationData">\n                        <div *ngIf="item.content_type == \'text\'">\n                            <show-html [htmlData]="item.content" ></show-html>\n                        </div>\n                        <div *ngIf="item.content_type == \'image\'">\n                            <customImage [imageSrc]="item.content" [customClass]="[\'imageCSS\']"></customImage>\n                        </div>\n                    </ion-col>\n                </ion-row>\n            </div>\n            <ion-row>\n                <ion-col col-12>\n                  <ion-label>\n                    Date \n                      <sup class="mendatFild">*</sup>\n                  </ion-label>\n                </ion-col>\n                <ion-col col-12>\n                    <ion-datetime [(ngModel)]="data.currunt_date" disabled displayFormat="MM/DD/YYYY"></ion-datetime>\n                </ion-col>\n            </ion-row>\n            <div class="headingDiv">\n                <p>Have you ever been known by another name?</p>\n            </div>\n            <div class="inputDiv" [ngClass]="{\'error\': !data.name_check.trim() && isSubmited}"><label>Check<sup class="mendatFild">*</sup>\n                </label>\n                <div class="genderDiv">\n                    <ion-list radio-group [(ngModel)]="data.name_check">\n                        <ion-row class="radioNewDiv">\n                            <ion-col col-6>\n                                <ion-item>\n                                    <ion-label>Yes</ion-label>\n                                    <ion-radio value="true"></ion-radio>\n                                </ion-item>\n                            </ion-col>\n                            <ion-col col-6>\n                                <ion-item>\n                                    <ion-label>No</ion-label>\n                                    <ion-radio value="false"></ion-radio>\n                                </ion-item>\n                            </ion-col>\n                        </ion-row>\n                    </ion-list>\n                </div>\n            </div>\n            <div *ngIf="data.name_check == \'true\'"  id="otherNameDiv" style="display: block;">\n                <div class="headingDiv">\n                    <p>If Yes, please share the name and duration since it changed</p>\n                </div>\n                <ion-row>\n                    <ion-col col-12>\n                        <ion-label>\n                            Other Name \n                                <sup class="mendatFild">*</sup>\n                        </ion-label>\n                        <ion-input\n                            type="text"  \n                            [ngClass]="{\'error\': !data.other_name.trim() && isSubmited}"\n                            [(ngModel)]="data.other_name" >\n                        </ion-input>\n                    </ion-col>\n                    <ion-col col-12>\n                        <ion-label>\n                            Date \n                            <sup class="mendatFild">*</sup>\n                        </ion-label>\n                        <ion-datetime \n                            [ngClass]="{\'error\': !data.other_date.trim() && isSubmited}"\n                            [(ngModel)]="data.other_date" \n                            displayFormat="MM/DD/YYYY">\n                        </ion-datetime>\n                    </ion-col>\n                </ion-row>\n            </div>\n        </div>\n        <div class="btndiv" *ngIf="formData && formData.form_status == \'enable\'">\n            <button ion-button class="btn" (click)="submit()">Submit</button>\n        </div>\n    </ion-col>\n  </ion-row>\n        </div>\n</ion-content>\n'/*ion-inline-end:"/home/benepik/Desktop/reach_git/new user app/test/Reach_Android_13_dec/Reach_Android/src/pages/onboarding_forms/Chile/declaration/declaration.html"*/
        }),
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DeclarationPageModule", function() { return DeclarationPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__declaration__ = __webpack_require__(1090);
...
var DeclarationPageModule = /** @class */ (function () {
    function DeclarationPageModule() {
    }
    DeclarationPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__declaration__["a" /* DeclarationPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["p" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__declaration__["a" /* DeclarationPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */]
            ],
        })
    ], DeclarationPageModule);
    return DeclarationPageModule;
}());

//# sourceMappingURL=declaration.module.js.map
