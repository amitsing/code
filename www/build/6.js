...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return BeneficiaryformPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_api_service_api_service__ = __webpack_require__(162);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_storage__ = __webpack_require__(161);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__response__ = __webpack_require__(1130);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__request__ = __webpack_require__(1131);
 ...
 */
var BeneficiaryformPage = /** @class */ (function () {
    function BeneficiaryformPage(navCtrl, navParams, _apiService, storage, toastCtrl, loadingCtrl, alertCtrl) {
        var _this = this;
    ...
    BeneficiaryformPage.prototype.editFamilyDetails = function (data) {
        this.data.forEach(function (ele) {
            if (ele == data) {
                ele.layout = __WEBPACK_IMPORTED_MODULE_4__response__["a" /* Layout */].FORM;
            }
            else {
                ele.layout = __WEBPACK_IMPORTED_MODULE_4__response__["a" /* Layout */].CARD;
            }
        });
        console.log(this.data);
    };
    BeneficiaryformPage.prototype.showConfirm = function (data) {
        var _this = this;
    ...
    BeneficiaryformPage.prototype.deleteFamilyDetail = function (data) {
        var _this = this;
        this.commonLoader();
        var apikey = {
        ...
        this._apiService
            ...
            if (res.success == "1") {
                ...
                if (_this.data.length == 0) {
                    _this.fill_status = "0";
                    var temp = new __WEBPACK_IMPORTED_MODULE_4__response__["b" /* Nominee */]();
    ...
    BeneficiaryformPage.prototype.changeToCard = function (data) {
        data.layout = __WEBPACK_IMPORTED_MODULE_4__response__["a" /* Layout */].CARD;
    };
    BeneficiaryformPage.prototype.submit = function (item) {
        var _this = this;
    ...
    BeneficiaryformPage.prototype.finalSubmit = function (data, formStatus) {
        var _this = this;
        console.log(this.data);
        var d = new __WEBPACK_IMPORTED_MODULE_5__request__["a" /* Benificiary */](data.benificry);
        console.log(d);
        this.commonLoader();
        var apikey = {
            client_id: this._apiService.clientId,
    ...
    BeneficiaryformPage.prototype.closeForm = function (item) {
        this.data = this.data.filter(function (element) {
            return element != item;
        });
    };
    BeneficiaryformPage.prototype.getData = function () {
        var _this = this;
        this.commonLoader();
        var apikey = {
            client_id: this._apiService.clientId,
        ...
        this._apiService.Uk_Get_Group_Protection(apikey, this.login_token).subscribe(function (res) {
            _this.loading.dismiss();
            console.log(res);
            if (res.success == "1") {
                console.log(res);
                ...
                if (res.first_attempt == "1") {
                    var tempArray = res.data.benificry;
                    var temp = new __WEBPACK_IMPORTED_MODULE_4__response__["b" /* Nominee */]();
                    temp.initializeData(tempArray[0]);
                    temp.layout = __WEBPACK_IMPORTED_MODULE_4__response__["a" /* Layout */].FORM;
                    temp.firstEdit = true;
                    _this.data.push(temp);
                }
                else {
    ...
    BeneficiaryformPage.prototype.submit_all = function () {
        var _this = this;
        this.commonLoader();
        var data_to_send = [];
        this.data.forEach(function (element) {
            var d = new __WEBPACK_IMPORTED_MODULE_5__request__["a" /* Benificiary */](element.benificry);
            data_to_send.push(d);
        });
        var apikey = {
            client_id: this._apiService.clientId,
    ...
    BeneficiaryformPage.prototype.addMember = function () {
        var _this = this;
    ...
    //Common Loader:
    BeneficiaryformPage.prototype.commonLoader = function () {
    ...
    BeneficiaryformPage.prototype.apiMessage = function (message) {
...
//# sourceMappingURL=beneficiaryform.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return Nominee; });
...
var Nominee = /** @class */ (function () {
    ...
    Nominee.prototype.initializeData = function (data) {
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return Benificiary; });
var Benificiary = /** @class */ (function () {
    function Benificiary(data) {
        this.auto_id = data.auto_id;
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BeneficiaryformPageModule", function() { return BeneficiaryformPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__beneficiaryform__ = __webpack_require__(1129);
...
var BeneficiaryformPageModule = /** @class */ (function () {
    function BeneficiaryformPageModule() {
    }
    BeneficiaryformPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__beneficiaryform__["a" /* BeneficiaryformPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["p" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__beneficiaryform__["a" /* BeneficiaryformPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */]
            ],
        })
    ], BeneficiaryformPageModule);
    return BeneficiaryformPageModule;
}());

//# sourceMappingURL=beneficiaryform.module.js.map
