...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return NomineesPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_api_service_api_service__ = __webpack_require__(162);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_storage__ = __webpack_require__(161);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__response__ = __webpack_require__(1125);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__request__ = __webpack_require__(1126);
 ...
 */
var NomineesPage = /** @class */ (function () {
    function NomineesPage(navCtrl, navParams, _apiService, storage, toastCtrl, loadingCtrl, alertCtrl) {
        var _this = this;
    ...
    NomineesPage.prototype.editFamilyDetails = function (data) {
        this.shareError = false;
        data.layout = __WEBPACK_IMPORTED_MODULE_4__response__["b" /* Layout */].FORM;
    };
    NomineesPage.prototype.showConfirm = function (data) {
        var _this = this;
    ...
    NomineesPage.prototype.deleteFamilyDetail = function (data) {
        var _this = this;
        this.commonLoader();
        var apikey = {
        ...
        this._apiService
            ...
            if (res.success == "1") {
                ...
                if (_this.data.length == 0) {
                    _this.fill_status = "0";
                    var temp = new __WEBPACK_IMPORTED_MODULE_4__response__["a" /* GratuityForm */]();
    ...
    NomineesPage.prototype.changeToCard = function (data) {
        data.layout = __WEBPACK_IMPORTED_MODULE_4__response__["b" /* Layout */].CARD;
    };
    NomineesPage.prototype.submit = function (item) {
        var _this = this;
        ...
        setTimeout(function () {
            ...
            if (!child) {
                ...
                if (!item.firstEdit) {
                    if (_this.fill_status == "1") {
                        var count_1 = 0;
                        _this.shareError = false;
                        _this.data.forEach(function (element) {
                            if (!element.firstEdit) {
                                element.layout = __WEBPACK_IMPORTED_MODULE_4__response__["b" /* Layout */].CARD;
                                count_1 += parseInt(element.GratuityDetails.gratuity_sharing_proportion.value);
                            }
                            else {
                        ...
                        console.log(count_1);
                        if (count_1 != 100 || count_1 == NaN) {
                            _this.shareError = true;
                            _this.apiMessage("Please make sure the sum of distributed share is 100%.");
                        }
                        else {
    ...
    NomineesPage.prototype.finalSubmit = function (data, formStatus) {
        var _this = this;
        console.log(this.data);
        var d = new __WEBPACK_IMPORTED_MODULE_5__request__["a" /* GratuityDetailsRequest */](data.GratuityDetails);
        console.log(d);
        this.commonLoader();
        var apikey = {
            client_id: this._apiService.clientId,
    ...
    NomineesPage.prototype.closeForm = function (item) {
        this.data = this.data.filter(function (element) {
            return element != item;
        });
    };
    NomineesPage.prototype.getData = function () {
        var _this = this;
        this.commonLoader();
        var apikey = {
            client_id: this._apiService.clientId,
        ...
        this._apiService.IndiaGetGratuityForm(apikey, this.login_token).subscribe(function (res) {
            _this.loading.dismiss();
            if (res.success == "1") {
                console.log(res);
    ...
    NomineesPage.prototype.addMember = function () {
        var _this = this;
        this.shareError = false;
    ...
    NomineesPage.prototype.submit_all = function () {
        var _this = this;
        var count = 0;
        this.shareError = false;
        this.data.forEach(function (element) {
            if (!element.firstEdit) {
                element.layout = __WEBPACK_IMPORTED_MODULE_4__response__["b" /* Layout */].CARD;
                count += parseInt(element.GratuityDetails.gratuity_sharing_proportion.value);
            }
            else {
                _this.data = _this.data.filter(function (item) {
                    return element != item;
        ...
        if (count != 100 || count == NaN) {
            ...
            var data_to_send_1 = [];
            this.data.forEach(function (element) {
                var d = new __WEBPACK_IMPORTED_MODULE_5__request__["a" /* GratuityDetailsRequest */](element.GratuityDetails);
                data_to_send_1.push(d);
            });
            var apikey = {
                client_id: this._apiService.clientId,
                employee_id: this.employeeId,
    ...
    NomineesPage.prototype.ionViewDidLoad = function () {
        console.log("ionViewDidLoad NomineesPage");
    };
    //Common Loader:
    NomineesPage.prototype.commonLoader = function () {
    ...
    NomineesPage.prototype.apiMessage = function (message) {
...
//# sourceMappingURL=nominees.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return GratuityForm; });
/* unused harmony export GratuityDetails */
/* unused harmony export metaData */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return Layout; });
var GratuityForm = /** @class */ (function () {
    function GratuityForm() {
        this.layout = Layout.FORM,
            this.firstEdit = true;
        this.GratuityDetails = new GratuityDetails();
    }
    GratuityForm.prototype.initializeData = function (data) {
...
var GratuityDetails = /** @class */ (function () {
    function GratuityDetails() {
        this.auto_id = "";
    ...
    GratuityDetails.prototype.initializeGratuityDetails = function (data) {
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return GratuityDetailsRequest; });
var GratuityDetailsRequest = /** @class */ (function () {
    function GratuityDetailsRequest(data) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NomineesPageModule", function() { return NomineesPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__nominees__ = __webpack_require__(1124);
...
var NomineesPageModule = /** @class */ (function () {
    function NomineesPageModule() {
    }
    NomineesPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__nominees__["a" /* NomineesPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["p" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__nominees__["a" /* NomineesPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */]
            ],
        })
    ], NomineesPageModule);
    return NomineesPageModule;
}());

//# sourceMappingURL=nominees.module.js.map
