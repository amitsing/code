...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return PolicyDeclarationPage; });
 ...
 */
var PolicyDeclarationPage = /** @class */ (function () {
    function PolicyDeclarationPage(navCtrl, navParams, _apiService, storage, toastCtrl, loadingCtrl) {
        var _this = this;
    ...
    PolicyDeclarationPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad PolicyDeclarationPage');
    };
    PolicyDeclarationPage.prototype.getData = function () {
        var _this = this;
        this.commonLoader();
        var apikey = {
        ...
        this._apiService.getPolicyFormDeclaration(apikey, this.login_token).subscribe(function (res) {
    ...
    PolicyDeclarationPage.prototype.submit = function () {
        var _this = this;
        var apikey = {
            client_id: this._apiService.clientId,
            employee_id: this.employeeId,
        ...
        this._apiService
            ...
            console.log(res);
            if (res.success == '1') {
                _this.navCtrl.push('DeclarationotpPage', { "form_data": _this.formData, "otpdata": res.otp_id, "msgdata": res.message });
            }
        });
    };
    //Common Loader:
    PolicyDeclarationPage.prototype.commonLoader = function () {
    ...
    PolicyDeclarationPage.prototype.apiMessage = function (message) {
    ...
    PolicyDeclarationPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-policy-declaration',template:/*ion-inline-start:"/home/benepik/Desktop/reach_git/new user app/test/Reach_Android_13_dec/Reach_Android/src/pages/onboarding_forms/common_folder/policy-declaration/policy-declaration.html"*/'<!--\n  Generated template for the PolicyDeclarationPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n  <ion-navbar>\n    <ion-title>{{page_title}}</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n  <ion-row>\n      <ion-col col-12 *ngFor="let item of allData">\n          <div *ngIf="item.content_type == \'text\'">\n            <show-html [htmlData]="item.content" ></show-html>\n          </div>\n          <div *ngIf="item.content_type == \'image\'">\n              <customImage [imageSrc]="item.content" [customClass]="[\'imageCSS\']"></customImage>\n          </div>\n      </ion-col>\n      <ion-col col-12  *ngIf="formData && formData.form_status == \'enable\'">\n          <div text-center class="btndiv">\n              <button ion-button class="btn" (click)="submit()">I Acknowledge</button>\n          </div>\n      </ion-col>\n  </ion-row>\n\n</ion-content>\n'/*ion-inline-end:"/home/benepik/Desktop/reach_git/new user app/test/Reach_Android_13_dec/Reach_Android/src/pages/onboarding_forms/common_folder/policy-declaration/policy-declaration.html"*/,
        }),
    ...
    return PolicyDeclarationPage;
}());

//# sourceMappingURL=policy-declaration.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PolicyDeclarationPageModule", function() { return PolicyDeclarationPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__policy_declaration__ = __webpack_require__(1103);
...
var PolicyDeclarationPageModule = /** @class */ (function () {
    function PolicyDeclarationPageModule() {
    }
    PolicyDeclarationPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__policy_declaration__["a" /* PolicyDeclarationPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["p" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__policy_declaration__["a" /* PolicyDeclarationPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */]
            ],
        })
    ], PolicyDeclarationPageModule);
    return PolicyDeclarationPageModule;
}());

//# sourceMappingURL=policy-declaration.module.js.map
