...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FormElevenPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_api_service_api_service__ = __webpack_require__(162);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_storage__ = __webpack_require__(161);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__resposne__ = __webpack_require__(1113);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__request__ = __webpack_require__(1114);
...
var FormElevenPage = /** @class */ (function () {
    function FormElevenPage(navCtrl, navParams, _apiService, storage, toastCtrl, loadingCtrl, alertCtrl) {
        var _this = this;
    ...
    FormElevenPage.prototype.getDropDowns = function () {
        var _this = this;
        var apikey = {
        ...
        this._apiService
            ...
            console.log(res);
            _this.countryOptions = res.data.country;
            _this.martialOptions = res.data.maritial;
            // this.genderOption = res.data.relationship;
        });
    };
    FormElevenPage.prototype.getCityOptions = function (id) {
        var _this = this;
        var apikey = {
            client_id: this._apiService.clientId,
            employee_id: this.employeeId,
        ...
        this._apiService
            ...
            .subscribe(function (res) {
            console.log(res);
            _this.cityOptions = res.data.city;
            // this.genderOption = res.data.relationship;
        });
    };
    FormElevenPage.prototype.getData = function () {
        var _this = this;
        this.commonLoader();
        var apikey = {
            client_id: this._apiService.clientId,
        ...
        this._apiService.IndiaGetPfForm(apikey, this.login_token).subscribe(function (res) {
            _this.loading.dismiss();
            if (res.success == "1") {
                _this.fill_status = res.fill_status;
                _this.data = new __WEBPACK_IMPORTED_MODULE_4__resposne__["a" /* PF_Form */]();
                _this.data.initializePfForm(res.data);
    ...
    FormElevenPage.prototype.submit = function () {
        var _this = this;
        ...
        setTimeout(function () {
            ...
            if (!child) {
                ...
                var data = new __WEBPACK_IMPORTED_MODULE_5__request__["a" /* PF_Form_Req */](_this.data);
    ...
    FormElevenPage.prototype.save = function () {
        var data = new __WEBPACK_IMPORTED_MODULE_5__request__["a" /* PF_Form_Req */](this.data);
        // console.log(JSON.stringify(data));
        console.log(data);
        this.finalSubmit(data, "save");
    };
    FormElevenPage.prototype.finalSubmit = function (data, formStatus) {
        var _this = this;
        this.commonLoader();
        var apikey = {
            client_id: this._apiService.clientId,
        ...
        if (this.fill_status == '0') {
            this._apiService.IndiaSavePfForm(apikey, this.login_token).subscribe(function (res) {
                console.log(res);
                _this.loading.dismiss();
                if (res.success == "1") {
                    _this.apiMessage(res.message);
            ...
            this._apiService.IndiaUpdatePfForm(apikey, this.login_token).subscribe(function (res) {
                console.log(res);
                _this.loading.dismiss();
                if (res.success == "1") {
                    _this.apiMessage(res.message);
    ...
    FormElevenPage.prototype.ionViewDidLoad = function () {
        console.log("ionViewDidLoad EpfNominationPage");
    };
    FormElevenPage.prototype.getCutrrentDate = function () {
        var todayTime = new Date();
        return todayTime.getFullYear() + "-" + (todayTime.getMonth() + 1) + "-" + todayTime.getDate();
    };
    FormElevenPage.prototype.getFutureDate = function () {
        var todayTime = new Date();
        return todayTime.getFullYear() + 100 + "-" + (todayTime.getMonth() + 1) + "-" + todayTime.getDate();
    };
    //Common Loader:
    FormElevenPage.prototype.commonLoader = function () {
    ...
    FormElevenPage.prototype.apiMessage = function (message) {
    ...
    return FormElevenPage;
}());

//# sourceMappingURL=form-eleven.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return PF_Form; });
var PF_Form = /** @class */ (function () {
    function PF_Form() {
        this.kyc_info = new KycInfo();
        this.pension_info = new PensionInfo();
        this.personal_info = new PersonalInfo();
    }
    PF_Form.prototype.initializePfForm = function (data) {
...
var PersonalInfo = /** @class */ (function () {
    ...
    PersonalInfo.prototype.relationShipStatus = function () {
    ...
    PersonalInfo.prototype.initializePersonalInfo = function (data) {
...
var KycInfo = /** @class */ (function () {
    ...
    KycInfo.prototype.initializeKycInfo = function (data) {
    ...
    KycInfo.prototype.changefresherStatus = function () {
        this.is_fresher = !this.is_fresher;
    };
    return KycInfo;
}());
var PensionInfo = /** @class */ (function () {
    ...
    PensionInfo.prototype.initializePensionInfo = function (data) {
...
//# sourceMappingURL=resposne.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return PF_Form_Req; });
var PF_Form_Req = /** @class */ (function () {
    function PF_Form_Req(data) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FormElevenPageModule", function() { return FormElevenPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__form_eleven__ = __webpack_require__(1112);
...
var FormElevenPageModule = /** @class */ (function () {
    function FormElevenPageModule() {
    }
    FormElevenPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__form_eleven__["a" /* FormElevenPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["p" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__form_eleven__["a" /* FormElevenPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */]
            ],
        })
    ], FormElevenPageModule);
    return FormElevenPageModule;
}());

//# sourceMappingURL=form-eleven.module.js.map
