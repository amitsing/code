...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return BackgroundVerificationPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_api_service_api_service__ = __webpack_require__(162);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_storage__ = __webpack_require__(161);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__response_form_control__ = __webpack_require__(872);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__request_form_control__ = __webpack_require__(1089);
 ...
 */
var BackgroundVerificationPage = /** @class */ (function () {
    function BackgroundVerificationPage(navCtrl, navParams, _apiService, storage, _el, toastCtrl, loadingCtrl) {
        var _this = this;
    ...
    BackgroundVerificationPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad BackgroundVerificationPage');
    };
    BackgroundVerificationPage.prototype.getData = function () {
        var _this = this;
        this.commonLoader();
        var apikey = {
        ...
        this._apiService.ChilleBackGroundVerification(apikey, this.login_token).subscribe(function (res) {
            _this.loading.dismiss();
            if (res.success == '1') {
                _this.formData = new __WEBPACK_IMPORTED_MODULE_4__response_form_control__["a" /* BackgroundVerification */]();
                console.log(_this.formData);
                _this.formData.initializeModal(res.data);
                _this.fill_status = res.fill_status;
                _this.msg = res.message;
                console.log(typeof (_this.formData.background.userName.is_enable));
                setTimeout(function () {
    ...
    BackgroundVerificationPage.prototype.addListeners = function (childs) {
    ...
    BackgroundVerificationPage.prototype.submit = function () {
        var _this = this;
        ...
        setTimeout(function () {
            ...
            if (!child) {
                console.log(_this.formData);
                var data = new __WEBPACK_IMPORTED_MODULE_5__request_form_control__["a" /* SendData */](_this.formData);
    ...
    BackgroundVerificationPage.prototype.save = function () {
        var data = new __WEBPACK_IMPORTED_MODULE_5__request_form_control__["a" /* SendData */](this.formData);
        // console.log(JSON.stringify(data));
        console.log(data);
        this.finalSubmit(data, 'save');
    };
    BackgroundVerificationPage.prototype.finalSubmit = function (data, formStatus) {
        var _this = this;
        this.commonLoader();
        var apikey = {
            "client_id": this._apiService.clientId,
        ...
        this._apiService.chilleSubmitBackgroundVerification(apikey, this.login_token).subscribe(function (res) {
            console.log(res);
            _this.loading.dismiss();
            if (res.success == '1') {
                _this.apiMessage(res.message);
    ...
    //Common Loader:
    BackgroundVerificationPage.prototype.commonLoader = function () {
    ...
    BackgroundVerificationPage.prototype.apiMessage = function (message) {
...
//# sourceMappingURL=background-verification.js.map
...
var ReportingManeger = /** @class */ (function () {
    function ReportingManeger(data) {
...
//# sourceMappingURL=request-form-control.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BackgroundVerificationPageModule", function() { return BackgroundVerificationPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__background_verification__ = __webpack_require__(1088);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_ionic_tooltips__ = __webpack_require__(870);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var BackgroundVerificationPageModule = /** @class */ (function () {
    function BackgroundVerificationPageModule() {
    }
    BackgroundVerificationPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [__WEBPACK_IMPORTED_MODULE_2__background_verification__["a" /* BackgroundVerificationPage */]],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["p" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__background_verification__["a" /* BackgroundVerificationPage */]),
                __WEBPACK_IMPORTED_MODULE_3__directives_directives_module__["a" /* DirectivesModule */],
                __WEBPACK_IMPORTED_MODULE_4__components_components_module__["a" /* ComponentsModule */],
                __WEBPACK_IMPORTED_MODULE_5_ionic_tooltips__["a" /* TooltipsModule */].forRoot()
            ]
        })
    ], BackgroundVerificationPageModule);
    return BackgroundVerificationPageModule;
}());

//# sourceMappingURL=background-verification.module.js.map
