...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return IndiaEmgContactPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_api_service_api_service__ = __webpack_require__(162);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_storage__ = __webpack_require__(161);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__response__ = __webpack_require__(1118);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__request__ = __webpack_require__(1119);
...
/**
 * Generated class for the IndiaEmgContactPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var IndiaEmgContactPage = /** @class */ (function () {
    function IndiaEmgContactPage(navCtrl, navParams, _apiService, storage, toastCtrl, loadingCtrl, alertCtrl) {
        var _this = this;
    ...
    IndiaEmgContactPage.prototype.editFamilyDetails = function (data) {
        data.layout = __WEBPACK_IMPORTED_MODULE_4__response__["b" /* Layout */].FORM;
    };
    IndiaEmgContactPage.prototype.showConfirm = function (data) {
        var _this = this;
    ...
    IndiaEmgContactPage.prototype.deleteFamilyDetail = function (data) {
        var _this = this;
        this.commonLoader();
        var apikey = {
        ...
        this._apiService
            .IndiaDeleteContactDetails(apikey, this.login_token)
            .subscribe(function (res) {
            _this.loading.dismiss();
            if (res.success == "1") {
                _this.apiMessage(res.message);
                _this.data = _this.data.filter(function (element) {
                    return element != data;
                });
                if (_this.data.length == 0) {
                    _this.fill_status = "0";
                    var temp = new __WEBPACK_IMPORTED_MODULE_4__response__["a" /* EmergrncyContact */]();
    ...
    IndiaEmgContactPage.prototype.changeToCard = function (data) {
        data.layout = __WEBPACK_IMPORTED_MODULE_4__response__["b" /* Layout */].CARD;
    };
    IndiaEmgContactPage.prototype.submit = function (item) {
        var _this = this;
        ...
        setTimeout(function () {
            ...
            if (!child) {
                ...
                if (!item.firstEdit) {
                    _this.finalSubmit(item, "submit");
                }
                else {
                    _this.finalSubmit(item, "save");
                }
            }
            else {
    ...
    IndiaEmgContactPage.prototype.finalSubmit = function (data, formStatus) {
        var _this = this;
        console.log(this.data);
        var d = new __WEBPACK_IMPORTED_MODULE_5__request__["a" /* FamilyDetailRequest */](data.familyDetails);
        console.log(d);
        this.commonLoader();
        var apikey = {
            client_id: this._apiService.clientId,
        ...
        if (data.firstEdit) {
            this._apiService
                .IndiaSaveContactDetail(apikey, this.login_token)
                .subscribe(function (res) {
                _this.loading.dismiss();
                if (res.success == "1") {
                    _this.apiMessage(res.message);
            ...
            this._apiService
                .IndiaUpdateContactDetails(apikey, this.login_token)
                .subscribe(function (res) {
                _this.loading.dismiss();
                if (res.success == "1") {
                    _this.apiMessage(res.message);
    ...
    IndiaEmgContactPage.prototype.closeForm = function (item) {
        this.data = this.data.filter(function (element) {
            return element != item;
        });
    };
    IndiaEmgContactPage.prototype.getData = function () {
        var _this = this;
        this.commonLoader();
        var apikey = {
            client_id: this._apiService.clientId,
        ...
        this._apiService.IndiaGetContactDetail(apikey, this.login_token).subscribe(function (res) {
            _this.loading.dismiss();
            if (res.success == "1") {
                console.log(res);
                ...
                if (res.first_attempt == "1") {
                    ...
                    temp.layout = __WEBPACK_IMPORTED_MODULE_4__response__["b" /* Layout */].FORM;
                    temp.firstEdit = true;
                    _this.data.push(temp);
                }
                else {
    ...
    IndiaEmgContactPage.prototype.submit_all = function () {
        var _this = this;
        this.commonLoader();
        var data_to_send = [];
        this.data.forEach(function (element) {
            var d = new __WEBPACK_IMPORTED_MODULE_5__request__["a" /* FamilyDetailRequest */](element.familyDetails);
            data_to_send.push(d);
        });
        var apikey = {
            client_id: this._apiService.clientId,
        ...
        this._apiService.get_emergency_submit(apikey, this.login_token).subscribe(function (res) {
            _this.loading.dismiss();
            if (res.success == "1") {
                _this.apiMessage(res.message);
                _this.navCtrl.pop();
    ...
    IndiaEmgContactPage.prototype.addMember = function () {
        var _this = this;
    ...
    IndiaEmgContactPage.prototype.ionViewDidLoad = function () {
        console.log("ionViewDidLoad FamilyandemergencycontactPage");
    };
    //Common Loader:
    IndiaEmgContactPage.prototype.commonLoader = function () {
    ...
    IndiaEmgContactPage.prototype.apiMessage = function (message) {
    ...
    return IndiaEmgContactPage;
}());

//# sourceMappingURL=india-emg-contact.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return EmergrncyContact; });
/* unused harmony export FamilyDetails */
/* unused harmony export metaData */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return Layout; });
var EmergrncyContact = /** @class */ (function () {
    function EmergrncyContact() {
        this.layout = Layout.FORM,
            this.firstEdit = true;
        this.familyDetails = new FamilyDetails();
    }
    EmergrncyContact.prototype.initializeData = function (data) {
        this.layout = Layout.CARD;
        this.firstEdit = false;
        this.familyDetails.initializeFamilyDetails(data);
    };
    return EmergrncyContact;
}());

var FamilyDetails = /** @class */ (function () {
    ...
    FamilyDetails.prototype.initializeFamilyDetails = function (data) {
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FamilyDetailRequest; });
var FamilyDetailRequest = /** @class */ (function () {
    function FamilyDetailRequest(data) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "IndiaEmgContactPageModule", function() { return IndiaEmgContactPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__india_emg_contact__ = __webpack_require__(1117);
...
var IndiaEmgContactPageModule = /** @class */ (function () {
    function IndiaEmgContactPageModule() {
    }
    IndiaEmgContactPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__india_emg_contact__["a" /* IndiaEmgContactPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["p" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__india_emg_contact__["a" /* IndiaEmgContactPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */]
            ],
        })
    ], IndiaEmgContactPageModule);
    return IndiaEmgContactPageModule;
}());

//# sourceMappingURL=india-emg-contact.module.js.map
