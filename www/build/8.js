...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return IndiaInsurancePage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_api_service_api_service__ = __webpack_require__(162);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_storage__ = __webpack_require__(161);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__response__ = __webpack_require__(1121);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__request__ = __webpack_require__(1122);
 ...
 */
var IndiaInsurancePage = /** @class */ (function () {
    function IndiaInsurancePage(navCtrl, navParams, _apiService, storage, toastCtrl, loadingCtrl, alertCtrl) {
        var _this = this;
    ...
    IndiaInsurancePage.prototype.getData = function () {
        var _this = this;
        this.commonLoader();
        var apikey = {
    ...
    IndiaInsurancePage.prototype.getDropDowns = function () {
        var _this = this;
        var apikey = {
            client_id: this._apiService.clientId,
            employee_id: this.employeeId,
        ...
        this._apiService
            ...
            .subscribe(function (res) {
            console.log(res);
            _this.genderOption = res.data.relationship;
        });
    };
    IndiaInsurancePage.prototype.selectAccidental = function (item) {
        this.data.accidental.forEach(function (element) {
            if (item === element) {
    ...
    IndiaInsurancePage.prototype.selectSelf = function (item) {
        this.data.mediclaim.self.forEach(function (element) {
            if (item === element) {
                element.is_selected = !element.is_selected;
            }
            else {
    ...
    IndiaInsurancePage.prototype.selectSelfDependent = function (item) {
        var _this = this;
        this.familyFormFields = [];
        this.data.mediclaim.self_dependent.forEach(function (element) {
            if (item === element) {
                element.is_selected = !element.is_selected;
                if (element.is_selected) {
                    _this.familyPremium = element.family_premium;
                }
                else {
                    _this.familyPremium = [];
                }
    ...
    IndiaInsurancePage.prototype.selectFamilyMember = function (item) {
        var _this = this;
        item.is_selected = !item.is_selected;
        var count = this.familyFormFields.length;
        if (item.is_selected) {
            this.data.familyData.forEach(function (element) {
                if (item.relation_type == element.relation_type) {
                    var tempData = new __WEBPACK_IMPORTED_MODULE_4__response__["a" /* FamilyFormField */]();
                    ...
                    _this.familyFormFields.push(tempData);
                }
            });
            ...
            this.familyFormFields = this.familyFormFields.filter(function (data) {
                return data.member_relation.value != item.relation_name;
            });
        }
        console.log(this.familyFormFields);
    };
    IndiaInsurancePage.prototype.getTotal = function () {
        var count = 0;
        var SelfPremiumAmmount = 0;
        this.data.mediclaim.self_dependent.forEach(function (element) {
            if (element.is_selected) {
                SelfPremiumAmmount += parseInt(element.annual_premium);
                element.family_premium.forEach(function (item) {
                    if (item.is_selected) {
    ...
    // 1 == self
    // 2 == self_dependent
    IndiaInsurancePage.prototype.changeMediclaimStatus = function (num) {
        if (num == 1) {
    ...
    IndiaInsurancePage.prototype.checkStatus = function () {
        var status = false;
        ...
        if (!this.data.mediclaim.self_selected) {
            status = false;
            this.familyPremium.forEach(function (element) {
                if (element.is_selected) {
                    status = true;
                }
            });
    ...
    IndiaInsurancePage.prototype.submit = function () {
        var _this = this;
    ...
    IndiaInsurancePage.prototype.showForms = function () {
    ...
    IndiaInsurancePage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad IndiaInsurancePage');
    };
    IndiaInsurancePage.prototype.initialization = function () {
        var _this = this;
        this.data.mediclaim.self_dependent.forEach(function (element) {
            if (element.is_selected) {
                _this.familyPremium = element.family_premium;
                element.family_premium.forEach(function (data) {
                    if (data.is_selected) {
                        _this.data.familyData.forEach(function (ele) {
    ...
    IndiaInsurancePage.prototype.save = function () {
        var _this = this;
        var data = new __WEBPACK_IMPORTED_MODULE_5__request__["a" /* InsuranceSendData */](this.data, this.familyFormFields);
        this.commonLoader();
        var apikey = {
            client_id: this._apiService.clientId,
            employee_id: this.employeeId,
    ...
    IndiaInsurancePage.prototype.final_Submit = function () {
        var _this = this;
        var data = new __WEBPACK_IMPORTED_MODULE_5__request__["a" /* InsuranceSendData */](this.data, this.familyFormFields);
        this.commonLoader();
        var apikey = {
    ...
    //Common Loader:
    IndiaInsurancePage.prototype.commonLoader = function () {
    ...
    IndiaInsurancePage.prototype.apiMessage = function (message) {
    ...
    return IndiaInsurancePage;
}());

//# sourceMappingURL=india-insurance.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FamilyFormField; });
/* unused harmony export metaData */
var FamilyFormField = /** @class */ (function () {
    function FamilyFormField() {
        this.member_dob = new metaData();
        this.member_name = new metaData();
        this.gender = new metaData();
        this.member_relation = new metaData();
    }
    return FamilyFormField;
}());
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return InsuranceSendData; });
/* unused harmony export FamilyForm */
var InsuranceSendData = /** @class */ (function () {
    function InsuranceSendData(data, familydata) {
        var _this = this;
        this.accidental = {};
        this.familyData = [];
        this.mediclaim = {};
        data.accidental.forEach(function (ele) {
            if (ele.is_selected) {
                _this.accidental.option_id = ele.auto_id;
            }
        });
        if (data.mediclaim.self_selected) {
            this.mediclaim.self_dependent = 'false';
            data.mediclaim.self.forEach(function (ele) {
                if (ele.is_selected) {
                    _this.mediclaim.option_id = ele.auto_id;
                }
            });
        }
        else {
            this.mediclaim.self_dependent = 'true';
            data.mediclaim.self_dependent.forEach(function (ele) {
                if (ele.is_selected) {
                    _this.mediclaim.option_id = ele.auto_id;
                }
            });
        }
        familydata.forEach(function (ele) {
            var temp = new FamilyForm(ele);
            _this.familyData.push(temp);
        });
    }
    return InsuranceSendData;
}());

var FamilyForm = /** @class */ (function () {
    function FamilyForm(data) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "IndiaInsurancePageModule", function() { return IndiaInsurancePageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__india_insurance__ = __webpack_require__(1120);
...
var IndiaInsurancePageModule = /** @class */ (function () {
    function IndiaInsurancePageModule() {
    }
    IndiaInsurancePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__india_insurance__["a" /* IndiaInsurancePage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["p" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__india_insurance__["a" /* IndiaInsurancePage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */]
            ],
        })
    ], IndiaInsurancePageModule);
    return IndiaInsurancePageModule;
}());

//# sourceMappingURL=india-insurance.module.js.map
