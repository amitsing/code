...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return LikeUsersListPage; });
 ...
 */
var LikeUsersListPage = /** @class */ (function () {
    function LikeUsersListPage(storage, apiServices, alertCtrl, imageViewerCtrl, navCtrl, navParams) {
        var _this = this;
    ...
    LikeUsersListPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad LikeUsersListPage');
        this.getlikeListFun();
    };
    LikeUsersListPage.prototype.getlikeListFun = function () {
        var _this = this;
        this.storage.get('employeeId').then(function (data) {
            _this.employeeId = data;
            console.log(' employeeId== ', _this.employeeId);
        ...
        this.storage.get('deviceId').then(function (data) {
            ...
            var apiKey = {
                ...
                "val": _this.value,
                "flag": _this.previousePageDataFlag,
                "post_id": _this.previousePageData.auto_id,
            };
            _this.apiServices.userlikeListApi(apiKey, _this.login_token)
                .subscribe(function (res) {
                console.log('likeUsersData List res==', res);
                if (res.success == 1) {
                    if (_this.likeUsersData == undefined) {
                        _this.likeUsersData = res.data;
                        console.log('likeUsersData List data==', _this.likeUsersData);
                    }
                    else {
                        _this.likeUsersData = _this.likeUsersData.concat(res.data);
                        console.log('new data== ', _this.likeUsersData);
    ...
    LikeUsersListPage.prototype.presentImage = function (myImage) {
    ...
    LikeUsersListPage.prototype.doInfinite = function (infiniteScroll) {
        var _this = this;
        this.myinfinte = infiniteScroll;
        console.log('Begin async operation');
        setTimeout(function () {
            _this.value = _this.likeUsersData.length;
            _this.getlikeListFun();
        }, 500);
    };
    LikeUsersListPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-like-users-list',template:/*ion-inline-start:"/home/benepik/Desktop/reach_git/new user app/test/Reach_Android_13_dec/Reach_Android/src/pages/like-users-list/like-users-list.html"*/'<!--\n  Generated template for the LikeUsersListPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n  <ion-navbar>\n    <ion-title> {{likeUsersData?.length}} Like<span *ngIf="likeUsersData?.length>1">s</span></ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n\n<div *ngFor="let data of likeUsersData">\n  <like-users [userImage]="data?.like_by_image" [userName]="data?.like_by_name" [userdate]="data?.date_time" ></like-users>\n</div>\n\n\n<ion-infinite-scroll (ionInfinite)="doInfinite($event)">\n    <ion-infinite-scroll-content></ion-infinite-scroll-content>\n  </ion-infinite-scroll>\n</ion-content>\n'/*ion-inline-end:"/home/benepik/Desktop/reach_git/new user app/test/Reach_Android_13_dec/Reach_Android/src/pages/like-users-list/like-users-list.html"*/,
        }),
    ...
    return LikeUsersListPage;
}());

//# sourceMappingURL=like-users-list.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LikeUsersListPageModule", function() { return LikeUsersListPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__like_users_list__ = __webpack_require__(1076);
...
var LikeUsersListPageModule = /** @class */ (function () {
    function LikeUsersListPageModule() {
    }
    LikeUsersListPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__like_users_list__["a" /* LikeUsersListPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["p" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__like_users_list__["a" /* LikeUsersListPage */]), __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */], __WEBPACK_IMPORTED_MODULE_4_ionic_img_viewer__["b" /* IonicImageViewerModule */]
            ],
        })
    ], LikeUsersListPageModule);
    return LikeUsersListPageModule;
}());

//# sourceMappingURL=like-users-list.module.js.map
