...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return RomaniaCommonPage; });
 ...
 */
var RomaniaCommonPage = /** @class */ (function () {
    function RomaniaCommonPage(navCtrl, navParams, _apiService, storage, _el, toastCtrl, loadingCtrl) {
        var _this = this;
    ...
    RomaniaCommonPage.prototype.hideLangPopUp = function (val) {
        if (val == 'show') {
    ...
    RomaniaCommonPage.prototype.getData = function () {
        var _this = this;
        this.commonLoader();
        var apikey = {
        ...
        this._apiService.RomaniaGetForm(apikey, this.login_token).subscribe(function (res) {
            _this.loading.dismiss();
            if (res.success == '1') {
                console.log(res);
                _this.allData = res.data;
                _this.language = res.language;
                _this.selectedLanguage = _this.language[0];
    ...
    RomaniaCommonPage.prototype.submit = function () {
        var _this = this;
        this.commonLoader();
        var apikey = {
            "client_id": this._apiService.clientId,
        ...
        this._apiService.RomaniaSubmitForm(apikey, this.login_token).subscribe(function (res) {
            _this.loading.dismiss();
            if (res.success == '1') {
                _this.apiMessage(res.message);
                _this.navCtrl.pop();
    ...
    RomaniaCommonPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad RomaniaCommonPage');
    };
    //Common Loader:
    RomaniaCommonPage.prototype.commonLoader = function () {
    ...
    RomaniaCommonPage.prototype.apiMessage = function (message) {
    ...
    return RomaniaCommonPage;
}());

//# sourceMappingURL=romania-common.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RomaniaCommonPageModule", function() { return RomaniaCommonPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__romania_common__ = __webpack_require__(1128);
...
var RomaniaCommonPageModule = /** @class */ (function () {
    function RomaniaCommonPageModule() {
    }
    RomaniaCommonPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__romania_common__["a" /* RomaniaCommonPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["p" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__romania_common__["a" /* RomaniaCommonPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */]
            ],
        })
    ], RomaniaCommonPageModule);
    return RomaniaCommonPageModule;
}());

//# sourceMappingURL=romania-common.module.js.map
