...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__response__ = __webpack_require__(1110);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__request__ = __webpack_require__(1111);
...
var FamilyDetailsPage = /** @class */ (function () {
    function FamilyDetailsPage(navCtrl, navParams, _apiService, storage, toastCtrl, loadingCtrl, alertCtrl) {
        var _this = this;
    ...
    FamilyDetailsPage.prototype.editFamilyDetails = function (data) {
        data.layout = __WEBPACK_IMPORTED_MODULE_4__response__["b" /* Layout */].FORM;
    };
    FamilyDetailsPage.prototype.submit_all = function () {
        var _this = this;
        this.commonLoader();
        var data_to_send = [];
    ...
    FamilyDetailsPage.prototype.showConfirm = function (data) {
        var _this = this;
    ...
    FamilyDetailsPage.prototype.deleteFamilyDetail = function (data) {
        var _this = this;
        this.commonLoader();
        var apikey = {
            client_id: this._apiService.clientId,
        ...
        this._apiService
            ...
            if (res.success == "1") {
                ...
                if (_this.data.length == 0) {
                    _this.fill_status = "0";
                    var temp = new __WEBPACK_IMPORTED_MODULE_4__response__["a" /* Data */]();
    ...
    FamilyDetailsPage.prototype.changeToCard = function (data) {
        data.layout = __WEBPACK_IMPORTED_MODULE_4__response__["b" /* Layout */].CARD;
    };
    FamilyDetailsPage.prototype.submit = function (item) {
        var _this = this;
    ...
    FamilyDetailsPage.prototype.finalSubmit = function (data, formStatus) {
        var _this = this;
    ...
    FamilyDetailsPage.prototype.closeForm = function (item) {
        this.data = this.data.filter(function (element) {
            return element != item;
        });
    };
    FamilyDetailsPage.prototype.getData = function () {
        var _this = this;
        this.commonLoader();
        var apikey = {
            client_id: this._apiService.clientId,
        ...
        this._apiService.IndiaGetFamilyDetail(apikey, this.login_token).subscribe(function (res) {
            _this.loading.dismiss();
            if (res.success == "1") {
                console.log(res);
    ...
    FamilyDetailsPage.prototype.addMember = function () {
        var _this = this;
        var item = [];
        this.data.forEach(function (element) {
    ...
    FamilyDetailsPage.prototype.getDropDowns = function () {
        var _this = this;
        var apikey = {
            client_id: this._apiService.clientId,
            employee_id: this.employeeId,
        ...
        this._apiService
            ...
            .subscribe(function (res) {
            console.log(res);
            _this.blood_group = res.data.relationship;
            _this.genderOptions = res.data.gender;
        });
    };
    FamilyDetailsPage.prototype.ionViewDidLoad = function () {
        console.log("ionViewDidLoad FamilyandemergencycontactPage");
    };
    //Common Loader:
    FamilyDetailsPage.prototype.commonLoader = function () {
    ...
    FamilyDetailsPage.prototype.apiMessage = function (message) {
...
var Data = /** @class */ (function () {
    ...
    Data.prototype.initializeData = function (data) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FamilyandemergencycontactPageModule", function() { return FamilyandemergencycontactPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__family_details__ = __webpack_require__(1109);
...
var FamilyandemergencycontactPageModule = /** @class */ (function () {
    function FamilyandemergencycontactPageModule() {
    }
    FamilyandemergencycontactPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__family_details__["a" /* FamilyDetailsPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["p" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__family_details__["a" /* FamilyDetailsPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */]
            ],
        })
    ], FamilyandemergencycontactPageModule);
    return FamilyandemergencycontactPageModule;
}());

//# sourceMappingURL=family-details.module.js.map
