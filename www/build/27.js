...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_ionic_angular_components_app_app__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_native_android_permissions__ = __webpack_require__(173);
...
var HomePage = /** @class */ (function () {
    function HomePage(app, androidPermissions, menu, fcm, alertCtrl, platform, events, ngZone, toastCtrl, modalCtrl, storage, navCtrl, navParams, apiServices) {
        // this.joineehomedata();
        var _this = this;
        this.app = app;
        ...
        this.joinehomedata = [];
        this.survey = [];
        this.aboutEvalBg = '../../assets/imgs/background.png';
        this.closeAppPopupShow = 0;
        this.getTokenTry = 1;
        this.albumVal = '';
        this.bgImage = 'http://webresizer.com/images2/bird1_after.jpg';
        this.vid_url = 'https://www.youtube.com/embed/f5FSu_AWlfw';
        this.newsVal = '';
        this.newsListData = [];
        this.countryHeadVal = 0;
        this.countryHeadData = [];
        this.lifeAtEvaData = [];
        this.storage.get('joining_status').then(function (data) {
            _this.joining_status = data;
            console.log('login joining_status== ', _this.joining_status);
        });
        this.storage.remove('welcome_aboard_applicable').then(function (data) {
            // alert('check--'+ data);
        });
        ...
        events.subscribe('reloadHomePage', function (data) {
    ...
    HomePage.prototype.goToLearnngList = function (data) {
        this.navCtrl.push('LearningListPage', { 'data': data });
    };
    HomePage.prototype.camPermissionON = function () {
        var _this = this;
        //camera permission
    ...
    HomePage.prototype.doRefresh = function (refresher) {
        ...
        setTimeout(function () {
            ...
            _this.countryHeadData = [];
            _this.joinehomedata = [];
            _this.lifeAtEvaData = [];
            _this.newsListData = [];
            _this.joineehomedata();
            _this.forcedata();
            _this.getcountryHeadMessgaeList();
            _this.lifeAtEvalFun();
            _this.getOnboardNewsList();
            refresher.complete();
        }, 2000);
    };
    ...
    HomePage.prototype.ionViewWillEnter = function () {
        ...
        this.storage.get('joining_status').then(function (data) {
            ...
            // });
            _this.storage.get('survey_data').then(function (sdata) {
                _this.recruitsurvey = sdata;
                console.log('login joining_status== ', _this.joining_status);
                if (_this.joining_status == 1) {
                    console.log('recruitsurvey12', _this.recruitsurvey);
                    if (_this.recruitsurvey.survey_data.length > 0) {
                        _this.surveyalertfunction(_this.recruitsurvey.survey_data[0]);
                    }
                    else {
                        _this.alertfunction();
                    }
    ...
    HomePage.prototype.homePageData = function () {
        var _this = this;
        var apiKey = {
        ...
        this.apiServices.homePageApi(apiKey).then(function (result) {
            console.log('home page message== ', result);
            _this.allData = result;
            if (_this.allData.success == 1) {
                var mainData_1 = _this.allData.data;
                setTimeout(function () {
                    _this.welcomeData = mainData_1;
                    _this.alertInfoMsg = _this.allData.learningMessage;
                    console.log('home page all data== ', _this.welcomeData);
                    _this.progressGraph = _this.welcomeData.progress;
                    console.log('home page progressGraph data== ', _this.progressGraph);
                    _this.courseData = _this.welcomeData.learning;
                    console.log('home page courseData data== ', _this.courseData);
                }, 100);
            }
            else {
    ...
    HomePage.prototype.apiMessage = function (message) {
    ...
    HomePage.prototype.forcedata = function () {
        ...
        this.storage.get('login_token').then(function (data) {
            ...
            var apiKey = {
                ...
                "employee_type": _this.employee_type
            };
            _this.apiServices.newForceUpdate(apiKey, _this.login_token).subscribe(function (result) {
                ...
                _this.allposts = result.data;
                console.log('forceupdate api response== ', _this.allposts);
                _this.checkVersionOfApp(_this.allposts);
            });
        });
    };
    // Check Version And Set token
    HomePage.prototype.checkVersionOfApp = function (forceupdateData) {
        ...
        if (forceupdateData.survey_id != '') {
            var modal = this.modalCtrl.create('EvalmadatorysurveyPage', { 'surveyid': forceupdateData.survey_id });
    ...
    HomePage.prototype.gcmApi = function (pushToken) {
        var _this = this;
        this.storage.get('showOnBoard').then(function (data) {
            console.log('showOnBoard value is111==', data);
            _this.employee_type = data;
        });
        var GCMapi_webWorker_result = new Worker('./assets/workers/GCMapi_webWorker.js');
        GCMapi_webWorker_result.onmessage = function (event) {
            _this.ngZone.run(function () {
                _this.gcmData = event.data;
                console.log('gcm api', _this.gcmData);
            });
        };
        this.storage.get('employeeId').then(function (data) {
            _this.employeeId = data;
            var passkey = {
                ...
                "device_id": _this.deviceId,
                "app_version": _this.apiServices.appVersion,
                "baseURL": _this.apiServices.joineefcmDetails_webWorkerURL,
                "registration_token": pushToken,
                "token": _this.login_token,
    ...
    HomePage.prototype.seemorebatchmeate = function () {
        this.navCtrl.push('WelcomOnboardPage');
    };
    HomePage.prototype.sureSignOut = function () {
        var _this = this;
        var apiKey = {
        ...
        this.apiServices.userSignOut(apiKey, this.login_token).subscribe(function (result) {
    ...
    HomePage.prototype.gotoFu = function () {
        // let param = {
    ...
    HomePage.prototype.getPushToken = function () {
        var _this = this;
        ...
        this.fcm.getToken().then(function (token) {
            ...
            if (token == '' || token == undefined) {
                if (_this.getTokenTry <= 2) {
                    ...
                    if (_this.getTokenTry == 3) {
                        _this.pushToken = "";
                        _this.gcmApi(_this.pushToken);
                    }
                }
            }
            else {
    ...
    HomePage.prototype.goToDynamicModule = function (item) {
        this.navCtrl.push('OnboardingDynamicModuleListPage', { 'data': item });
    };
    HomePage.prototype.joineehomedata = function () {
        var _this = this;
        this.storage.get('deviceId').then(function (data) {
            _this.deviceId = data;
            console.log('login deviceId== ', _this.deviceId);
        ...
        this.storage.get('login_token').then(function (data) {
            ...
            _this.apiServices.joineehomepage(apiKey, _this.login_token).subscribe(function (result) {
                ...
                _this.joinehomedata = result.data;
                _this.dynamicModule = _this.joinehomedata.dynamic_module;
                _this.formdata = result.data.go_to_form;
                _this.upperGraphData = result.data.progress;
                _this.welcomeData = [];
                _this.survey = result.data.survey;
                _this.quizimg = result.quiz_background_image;
                _this.employer_award_all_images = result.employer_award_all_images;
                console.log('this.allData.alert_count == ', result.alert_count);
                _this.events.publish('showsidemenu', result.employee_type, result.country_id);
                _this.events.publish('tabbadgedata', result.alert_count);
                console.log('this.formdata==', _this.formdata);
                console.log('upperGraphData==', _this.upperGraphData);
            });
        });
    };
    HomePage.prototype.getOnboardAlbumList = function () {
        var _this = this;
        var homeAlbumList_webWorker = new Worker('./assets/workers/albumList_webWorker.js');
        homeAlbumList_webWorker.onmessage = function (event) {
            _this.ngZone.run(function () {
                var myhomeAlbumData = event.data;
                console.log('homeAlbumList_webWorker res', myhomeAlbumData);
                if (myhomeAlbumData.success == 1) {
                    _this.homeAlbumData = myhomeAlbumData.data;
                }
                else {
                    _this.homeAlbumData = [];
                }
                console.log('homeAlbumList_webWorker res', _this.homeAlbumData);
            });
        };
        this.storage.get('login_token').then(function (data) {
        ...
        this.storage.get('employeeId').then(function (data) {
            ...
            var passkey = {
                ...
                "device_id": _this.deviceId,
                "app_version": _this.apiServices.appVersion,
                "baseURL": _this.apiServices.albumList_webWorkerURL,
                "token": _this.login_token,
                "val": _this.albumVal,
                'employee_type': _this.employee_type
            };
    ...
    HomePage.prototype.seeAlbumdetails = function (data) {
        this.navCtrl.push('AlbumDetailsPage', { 'data': data });
    };
    HomePage.prototype.getOnboardNewsList = function () {
        var _this = this;
        var newsList_webWorker = new Worker('./assets/workers/newslist_webWorker.js');
        newsList_webWorker.onmessage = function (event) {
            _this.ngZone.run(function () {
                var newsList = event.data;
                console.log('newsList_webWorker res', newsList);
                _this.newsListData = newsList.data;
                console.log('newsList_webWorker res', _this.newsListData);
            });
        };
        this.storage.get('login_token').then(function (data) {
            console.log('login_token==', data);
        ...
        this.storage.get('employeeId').then(function (data) {
            ...
            var passkey = {
                ...
                "device_id": _this.deviceId,
                "app_version": _this.apiServices.appVersion,
                "baseURL": _this.apiServices.onboardNewsList_webWorkerURL,
                "token": _this.login_token,
                "val": _this.newsVal,
                'employee_type': _this.employee_type
            };
    ...
    HomePage.prototype.getcountryHeadMessgaeList = function () {
        var _this = this;
        var countryHeadMessgae_webWorker = new Worker('./assets/workers/countryHeadMessgaeList_webWorker.js');
        countryHeadMessgae_webWorker.onmessage = function (event) {
            _this.ngZone.run(function () {
                var allData = event.data;
                console.log('countryHeadMessgae_webWorker res', allData);
                if (allData.success == 1) {
                    if (_this.countryHeadData == undefined) {
                        _this.countryHeadData = allData.data;
                        console.log('countryHeadMessgae_webWorker res', _this.countryHeadData);
                    }
                    else {
                        _this.countryHeadData = _this.countryHeadData.concat(allData.data);
                        console.log('countryHeadMessgae_webWorker res', _this.countryHeadData);
                    }
                }
                else {
        ...
        this.storage.get('employeeId').then(function (data) {
            ...
            var passkey = {
                ...
                "device_id": _this.deviceId,
                "app_version": _this.apiServices.appVersion,
                "baseURL": _this.apiServices.countryHeadMsgList_webWorkerURL,
                "token": _this.login_token,
                "val": _this.countryHeadVal,
                'employee_type': _this.employee_type
            };
    ...
    HomePage.prototype.gotourllist = function (grpid, data) {
    ...
    HomePage.prototype.gotoAlbumCat = function () {
    ...
    HomePage.prototype.gotoLifeEval = function (data) {
        this.navCtrl.push('LifeAtEvalDetailsPage', { 'data': data });
    };
    HomePage.prototype.countryHeadSlideChanged = function () {
    ...
    HomePage.prototype.lifeAtEvalFun = function () {
        var _this = this;
        ...
        this.storage.get('deviceId').then(function (data) {
            ...
            _this.apiServices.lifeAtEvalueserve(apiKey, _this.login_token).subscribe(function (result) {
                console.log(' lifeAtEval response== ', result);
                var allData = result;
                if (result.success == 1) {
                    _this.lifeAtEvaData = allData.data;
                }
                else {
                    _this.lifeAtEvaData = [];
                }
    ...
    HomePage.prototype.alertfunction = function () {
        var _this = this;
    ...
    HomePage.prototype.surveyalertfunction = function (recruitsurvey) {
        var _this = this;
        var alert = this.alertCtrl.create({
            // title: 'SIGNOUT!',
            ...
            buttons: [
                {
                    text: 'Ok',
                    handler: function () {
                        _this.navCtrl.push('TestsurveyPage', { 'surveyid': recruitsurvey.survey_id, 'recruitcheck': 1 });
                    }
                },
            ]
        });
    ...
    HomePage.prototype.goToOnboarding = function (data) {
        console.log("data", data);
        this.navCtrl.push('OnboardingFormsPage', { 'data': data });
    };
    HomePage.prototype.signoutUserFun = function () {
        var _this = this;
        this.storage.get('showOnBoard').then(function (data) {
            console.log('showOnBoard value is111==', data);
        ...
        this.storage.get('deviceId').then(function (data) {
            ...
            _this.apiServices.userSignoutApi(apiKey, _this.login_token)
                ...
                if (res.success == 1) {
                    ...
                    _this.app.getRootNav().setRoot('ChooseUserPage');
                }
                else {
    ...
    HomePage.prototype.gotosurvey = function (data) {
    ...
    HomePage.prototype.gotoquiz = function () {
        this.navCtrl.push('JoineequizinstructionPage');
    };
    HomePage.prototype.gotojoineeaward = function (imgdetail) {
        console.log('imgdetail', imgdetail);
        this.navCtrl.push('JoineeawardPage', { 'imgdetail': imgdetail });
    };
    HomePage.prototype.gotojoineeawardetail = function () {
        this.navCtrl.push('JoineeawardPage', { 'imgdetail': this.employer_award_all_images });
    };
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_8" /* ViewChild */])('countryHeadDataSlides'),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__home__ = __webpack_require__(1060);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__pipes_pipes_module__ = __webpack_require__(867);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var HomePageModule = /** @class */ (function () {
    ...
    HomePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["p" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__home__["a" /* HomePage */]), __WEBPACK_IMPORTED_MODULE_3_ng_circle_progress__["a" /* NgCircleProgressModule */], __WEBPACK_IMPORTED_MODULE_4__components_components_module__["a" /* ComponentsModule */], __WEBPACK_IMPORTED_MODULE_5__pipes_pipes_module__["a" /* PipesModule */]
                // RoundProgressModule
                // PipesModule,
            ],
        })
