...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return MadeMyDayPage; });
...
var MadeMyDayPage = /** @class */ (function () {
    function MadeMyDayPage(navCtrl, navParams) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.loadData();
    }
    MadeMyDayPage.prototype.loadData = function () {
        this.topImage = [
    ...
    MadeMyDayPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad MadeMyDayPage');
    };
    MadeMyDayPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-made-my-day',template:/*ion-inline-start:"/home/benepik/Desktop/reach_git/new user app/test/Reach_Android_13_dec/Reach_Android/src/pages/made-my-day/made-my-day.html"*/'<ion-header>\n    <ion-navbar><ion-title>Made My Day</ion-title></ion-navbar>\n  </ion-header>\n\n  \n\n  \n  <ion-content>\n    <div *ngIf="!topImage"><team-awesome></team-awesome></div>\n    \n    <div *ngIf="topImage">\n      <ion-row>\n        <ion-col *ngFor="let data of topImage">\n          <img src="../../assets/watermark/watermark.png" srcset="{{data?.image}}">\n        </ion-col>\n      </ion-row><br>\n    \n      <ion-row>\n        <ion-card class="visibleOverflow">\n          <ion-row *ngFor="let data of awardHead">\n            <ion-col col-12 margin-bottom>\n              <div class="topHeading">\n                <img src="../../assets/watermark/watermark.png" srcset="{{data?.image}}"><p>{{data.points}}<br>Points</p><h2>{{data.title}}</h2>\n              </div>\n            </ion-col>\n            <ion-col col-12>\n              <p class="headerTextColor">{{data.discription}}</p>\n            </ion-col>\n            <ion-col col-12 text-center>\n              <circle-progress\n                [percent]="55"\n                [radius]="50"\n                [outerStrokeWidth]="6"\n                [showTitle]=true\n                [showSubtitle]=false\n                [innerStrokeWidth]="3"\n                [outerStrokeColor]="\'#542e56\'"\n                [innerStrokeColor]="\'#7b4b7d\'"\n                [animation]="true"\n                [animationDuration]="300"\n              ></circle-progress>\n            </ion-col>\n            <ion-col col-12 text-center><p>Individual Awards</p></ion-col>\n          </ion-row>\n        </ion-card>\n      </ion-row><br>\n    \n      <ion-row>\n        <ion-card class="padd8">\n          <h2><b>People Rewarded Recently</b></h2><p>12 People have been awarded in last 6 days</p><br>\n          <ion-slides speed="500" spaceBetween="10" slidesPerView="2.5">\n            <ion-slide *ngFor="let data of peopleRewarded">\n              <div class="silverRela" margin-bottom>\n                <img class="padd5 dashedborder" src="../../assets/watermark/watermark.png" srcset="{{data?.image}}">\n                <img class="silverAbso" src="../../assets/watermark/watermark.png" srcset="{{data?.absimg}}">\n              </div>\n              <div text-left>\n                <h4><b>{{data.title}}</b></h4><p class="font12">{{data.subtitle}}</p>\n              </div>\n            </ion-slide>\n          </ion-slides>\n        </ion-card>\n      </ion-row><br>\n    \n      <ion-row>\n        <ion-col no-padding><button ion-button full class="bgRed">Nominate Now</button></ion-col>\n      </ion-row>\n    </div>\n  \n  </ion-content>\n  '/*ion-inline-end:"/home/benepik/Desktop/reach_git/new user app/test/Reach_Android_13_dec/Reach_Android/src/pages/made-my-day/made-my-day.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["u" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["v" /* NavParams */]])
    ], MadeMyDayPage);
    return MadeMyDayPage;
}());

//# sourceMappingURL=made-my-day.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MadeMyDayPageModule", function() { return MadeMyDayPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__made_my_day__ = __webpack_require__(1079);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(873);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_ng_circle_progress__ = __webpack_require__(372);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MadeMyDayPageModule = /** @class */ (function () {
    function MadeMyDayPageModule() {
    }
    MadeMyDayPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__made_my_day__["a" /* MadeMyDayPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["p" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__made_my_day__["a" /* MadeMyDayPage */]), __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */], __WEBPACK_IMPORTED_MODULE_4_ng_circle_progress__["a" /* NgCircleProgressModule */],
            ],
        })
    ], MadeMyDayPageModule);
    return MadeMyDayPageModule;
}());

//# sourceMappingURL=made-my-day.module.js.map
