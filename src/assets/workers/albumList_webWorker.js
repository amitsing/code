self.onmessage = function(event) {
    ...
    console.log('homeAlbumList_webWorker API keys:', event.data);
    console.log('homeAlbumList_webWorker inside webworker== ',event );
    var apikey={
    ...
    fetch(url, {
      ...
      const homeAlbumList_webWorker=data;
      console.log('homeAlbumList_webWorker API result== ',homeAlbumList_webWorker);
      self.postMessage(homeAlbumList_webWorker);
    }); 
   }    
