export class BackgroundVerification {
    ...
    public addAddress() {
        let tempAdd = new Address();
        this.previous_add.push(tempAdd);
        console.log('worked');
    }

    public removeAddress(data : Address) {
        this.previous_add = this.previous_add.filter((element)=>{
            return data != element;
        })
    }
...
class JoineeInfo {
    ...
    last_name: metaData;
    location_authorized_for_work: metaData;
...
class Address {
    ...
    address_type: null
    address_type_2: null;
    available_person_contact_number: metaData;
    city: metaData;
    complete_address: metaData;
    country: metaData;
    country_area_code: metaData;
    end_date: metaData;
    start_date: metaData;
    state: metaData;
    zipcode: metaData;
